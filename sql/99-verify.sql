...
FROM user_tab_columns
WHERE (table_name = 'PR_CHARGE_REQUEST_LOG' AND column_name IN ('RUNTIME_PACKAGE_ID', 'RUNTIME_PACKAGE_VERSION'))
   OR (table_name = 'PR_CHARGE_TRACE_STEP' AND column_name IN ('RUNTIME_PACKAGE_ID', 'RUNTIME_RULE_ID', 'SOURCE_POLICY_VERSION_ID', 'SOURCE_TEMPLATE_VERSION_ID'))
   OR (table_name = 'PR_CHARGE_DISCOUNT_DETAIL' AND column_name IN ('RUNTIME_PACKAGE_ID', 'RUNTIME_RULE_ID', 'SOURCE_POLICY_VERSION_ID', 'SOURCE_TEMPLATE_VERSION_ID'))
