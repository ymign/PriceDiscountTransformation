...
namespace His.Models.ZZSB
{
    ...
    public class PactInfo :  Pact,  ISort
	{
        ...
        /// 合同单位人员类别
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject patientType = new Neusoft.FrameWork.Models.NeuObject();

        /// <summary>
        /// 是否用于门诊收费
        /// </summary>
        private bool isUseInOutPatientFee;
        ...
        /// 合同单位人员类别
        /// </summary>
        public Neusoft.FrameWork.Models.NeuObject PatientType
        {
            get
            {
                return patientType;
        ...
        /// 是否用于门诊收费
        /// </summary>
        public bool IsUseInOutPatientFee
        {
            get
            {
                return isUseInOutPatientFee;
            }
            set
            {
                isUseInOutPatientFee = value;
            }
        }
		...
		public new PactInfo Clone()
		{
            ...
            pactInfo.PatientType = this.PatientType.Clone();
