...
namespace Neusoft.HISFC.BizProcess.Integrate.HealthRecord
{
    public class HealthRecordBase : IntegrateBase
    {
        ...
        public ArrayList QueryCaseDiagnose(string InpatientNO, string diagType, Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes OperType, Neusoft.HISFC.Models.Base.ServiceTypes personType)
        {
            this.SetDB(diagMgr);
