...
namespace Neusoft.HISFC.BizProcess.Integrate
{
    ...
    public class PharmacyMethod
    {
        ...
        public static Neusoft.HISFC.BizProcess.Interface.Pharmacy.IDrugBillClass myIDrugBillClass = null;
        ...
        public static Neusoft.HISFC.Models.Pharmacy.DrugBillClass GetDrugBill(Neusoft.HISFC.Models.Pharmacy.ApplyOut applyout)
        {
