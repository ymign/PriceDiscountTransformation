...
{
    public class MedcareInterfaceProxy : Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcare, Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareExtend, Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareBuDan
    {
        ...
        public int GetInterfaceFromPact(string pactCode)
        {
            ...
            try
            {
                ...
                if (pactInfo.PactDllName == "GDSI.dll")
                {
                    Assembly a = Assembly.LoadFrom(AppDomain.CurrentDomain.BaseDirectory + "\\" + pactInfo.PactDllName);
                ...
                {
                    Assembly a = Assembly.LoadFrom(AppDomain.CurrentDomain.BaseDirectory + "\\" + Neusoft.FrameWork.WinForms.Classes.Function.PluginPath + "\\SI\\" + pactInfo.PactDllName);
        ...
        /// <returns>-1 失败 0 没有记录 1 成功</returns>
        public int GetRegInfoOutpatient(Neusoft.HISFC.Models.Registration.Register r, bool isReadMCard)
        {
            try
            {
                if (!this.IsValid(r))
        ...
        public bool IsLocalProcess
        {
            get
            {
                if (this.medcaredInterface != null)
                {
                    if (this.medcaredInterface is Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareExtend)
                    {
                        return (this.medcaredInterface as Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareExtend).IsLocalProcess;
                    }
                    else
                    {
                        return false;
            ...
            set
            {
                if (this.medcaredInterface != null)
                {
                    if (this.medcaredInterface is Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareExtend)
                    {
                        (this.medcaredInterface as Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareExtend).IsLocalProcess = value;
                    }
                }
            }
        }
        ...
        /// <returns>-1 失败 0 没有记录 >=1 成功</returns>
        public int LocalBalanceOutpatient(Neusoft.HISFC.Models.Registration.Register r, ref ArrayList feeDetails, ArrayList arlOther)
        {
            int iRes = 1;
            this.errMsg = "";
            ...
            if (this.medcaredInterface != null)
            {
                if (this.medcaredInterface is Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareExtend)
                {
                    iRes = (this.medcaredInterface as Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareExtend).LocalBalanceOutpatient(r, ref feeDetails, arlOther);
                    //if (iRes <= 0)
                    //{
                    //    this.errMsg = this.medcaredInterface.ErrMsg;
                    //}
        ...
        /// <param name="feeDetails">患者费用信息</param>
        /// <returns>-1 失败 0 没有记录 >=1 成功</returns>
        public int BdBalanceOutpatient(Neusoft.HISFC.Models.Registration.Register r, ref ArrayList feeDetails)
        {
            int iRes = 1;
            this.errMsg = "";
            ...
            if (this.medcaredInterface != null)
            {
                if (this.medcaredInterface is Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareBuDan)
                {
                    iRes = (this.medcaredInterface as Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareBuDan).BdBalanceOutpatient(r, ref feeDetails);
                    this.errMsg = this.medcaredInterface.ErrMsg;
                }
            }
        ...
        /// <returns></returns>
        public int BalanceOutpatientAfterPreBalance(Neusoft.HISFC.Models.Registration.Register r, ref ArrayList feeDetails)
        {
            int iRes = 1;
            this.errMsg = "";
            ...
            if (this.medcaredInterface != null)
            {
                if (this.medcaredInterface is Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareBuDan)
                {
                    iRes = (this.medcaredInterface as Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMedcareBuDan).BalanceOutpatientAfterPreBalance(r, ref feeDetails);
                    this.errMsg = this.medcaredInterface.ErrMsg;
                }
            }
        ...
        //public int CancelSIBalance(Neusoft.HISFC.Models.RADT.PatientInfo patient, ref string error)
        //{
        //    return this.medcaredInterface.CancelSIBalance(patient, ref error);
        //}

        //public int CancelSIBeforeBalance(Neusoft.HISFC.Models.RADT.PatientInfo patient, ref string error)
        //{
