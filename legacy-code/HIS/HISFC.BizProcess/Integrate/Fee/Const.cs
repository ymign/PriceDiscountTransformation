...
namespace Neusoft.HISFC.BizProcess.Integrate
{
    public class Const
    {
        ...
        public static string GetOutpatientPlugInInterfaceNameByConstName(string constName)
        {
            ...
            hashTable.Add(INTERFACE_REGINFO, "Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientInfomation");
            hashTable.Add(INTERFACE_ITEM_INPUT, "Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientItemInputAndDisplay");
            hashTable.Add(INTERFACE_LEFT, "Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientOtherInfomationLeft");
            hashTable.Add(INTERFACE_RIGHT, "Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientOtherInfomationRight");
            hashTable.Add(INTERFACE_POP_FEE, "Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientPopupFee");
            hashTable.Add(INTERFACE_CHOOSE_ITEM, "Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IChooseItemForOutpatient");
        ...
        public static string GetOutpatientPlugInConstNameByInterfaceName(string interfaceName)
        {
            ...
            hashTable.Add("Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientInfomation", INTERFACE_REGINFO);
            hashTable.Add("Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientItemInputAndDisplay", INTERFACE_ITEM_INPUT);
            hashTable.Add("Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientOtherInfomationLeft", INTERFACE_LEFT);
            hashTable.Add("Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientOtherInfomationRight", INTERFACE_RIGHT);
            hashTable.Add("Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientPopupFee", INTERFACE_POP_FEE);
            hashTable.Add("Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IChooseItemForOutpatient", INTERFACE_CHOOSE_ITEM);
