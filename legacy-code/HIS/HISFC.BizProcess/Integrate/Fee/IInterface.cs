...
namespace Neusoft.HISFC.BizProcess.Integrate.FeeInterface
{
    ...
    */
    ...
    public interface IOutpatientItemInputAndDisplay
    {
        ...
        //void OutFlowDrug_SelectedItem(string itemCode, string drugFlag, string exeDeptCode, decimal price,int count,int rowNum);
        /// <summary>
        /// 是否转诊
        /// </summary>
        bool IsTransferTreat
    ...
    public interface IOutpatientOtherInfomationRight 
    {
        ...
        /// 左侧项目显示信息
        /// </summary>
        Neusoft.HISFC.BizProcess.Interface.FeeInterface.IMultiScreen MultiScreen {  set; }
    ...
    */
    ...
    public delegate void DelegatePatientSelected(Neusoft.HISFC.Models.Registration.Register register);
