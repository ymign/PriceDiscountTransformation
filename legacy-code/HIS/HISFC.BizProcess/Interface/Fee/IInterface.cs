...
namespace Neusoft.HISFC.BizProcess.Interface.FeeInterface
{
    ...
    public interface IOutScreen
    {
        ...
        /// </summary>
        /// <returns></returns>
        int ShowInfo(Neusoft.HISFC.Models.Registration.Register register);
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
    ...
    public interface IMedcare : IMedcareTranscation
    {
        ...
        /// </returns>
        int QueryCanMedicare(Neusoft.HISFC.Models.Registration.Register r);
        /// <summary>
        /// 获得黑名单信息
        /// </summary>
        ...
        /// <returns></returns>
        //int GetRegInfoOutpatient(Neusoft.HISFC.Models.Registration.Register r,bool isReadMCard);
        ...
        //int CancelSIBeforeBalance(Neusoft.HISFC.Models.RADT.PatientInfo patient, ref string error);

        //int CancelSIBalance(Neusoft.HISFC.Models.RADT.PatientInfo patient, ref string error);
        #endregion
        #endregion
    ...
    public interface IMedcareExtend
    {
        ...
        /// <returns>-1 失败 0 没有记录 >=1 成功</returns>
        int LocalBalanceOutpatient(Neusoft.HISFC.Models.Registration.Register r, ref ArrayList feeDetails, ArrayList arlOther);
    }
    ...
    {     
        ...
        /// <param name="feeDetails">患者费用信息</param>
        /// <returns>-1 失败 0 没有记录 >=1 成功</returns>
         int BdBalanceOutpatient(Neusoft.HISFC.Models.Registration.Register r, ref ArrayList feeDetails);
         /// <summary>
         ///预结算后记录社保的结算信息
         /// </summary>
         /// <param name="r"></param>
         ...
         /// <returns></returns>
         int BalanceOutpatientAfterPreBalance(Neusoft.HISFC.Models.Registration.Register r, ref System.Collections.ArrayList feeDetails);
    } 
    ...
    public interface IPrepayPrint 
    {
        ...
        /// <returns>成功 1 失败 -1</returns>
        int SetValue(Neusoft.HISFC.Models.RADT.PatientInfo patient, ArrayList alPrepay);
    ...
    public interface IOutPatientFeeRoundOff
    {
        ...
        void OutPatientFeeRoundOff(Neusoft.HISFC.Models.Registration.Register r, ref decimal totCost, ref Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList feeItemList, string recipeSequence);
    }
    ...
    public interface IInPatientFeeRoundOff
    {
        ...
        /// <param name="feeItemList"></param>
        /// <param name="recipeSequence"></param>
        void InPatientFeeRoundOff(Neusoft.HISFC.Models.RADT.PatientInfo patientInfo, ref decimal totCost, ref Neusoft.HISFC.Models.Fee.Inpatient.FeeItemList feeItemList);
    }
    ...
    public interface ILisCalculateTube
    {
        ...
        int LisCalculateTubeForOutPatient(Neusoft.HISFC.Models.Registration.Register r, ArrayList alFeeItemList, string recipeSequence, ref decimal owncost, ref ArrayList alTubeList);

        /// <summary>
        /// 住院计算试管接口
        /// </summary>
        /// <param name="patientInfo">患者信息</param>
        int LisCalculateTubeForInPatient(Neusoft.HISFC.Models.RADT.PatientInfo patientInfo);
    }
}
