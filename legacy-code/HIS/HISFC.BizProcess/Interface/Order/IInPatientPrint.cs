...
{
    public interface IInPatientPrint
    {
        ...
        /// <returns></returns>
        int OnInPatientPrint(Neusoft.HISFC.Models.RADT.PatientInfo patientInfo, NeuObject reciptDept, NeuObject reciptDoct, List<Neusoft.HISFC.Models.Order.Inpatient.Order> orderPrintList, List<Neusoft.HISFC.Models.Order.Inpatient.Order> orderSelectList, bool IsReprint, bool IsPreview, string printType, object obj);
