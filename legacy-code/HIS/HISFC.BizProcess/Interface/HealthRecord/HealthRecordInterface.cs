...
namespace Neusoft.HISFC.BizProcess.Interface.HealthRecord
{
    /// <summary>
    /// [功能描述: 病案接口类]<br></br>
    /// [创 建 者: 张俊义]<br></br>
    ...
    /// </summary>
    public interface HealthRecordInterfaceAdditional : Neusoft.FrameWork.WinForms.Forms.IReportPrinter
    {
        /// <summary>
        /// 病案实体 ,因为此实体聚合了Neusoft.HISFC.Models.RADT.PatientInfo，所以住院实体可以先转化成病案实体
        /// </summary>
