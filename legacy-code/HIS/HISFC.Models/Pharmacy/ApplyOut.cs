...
namespace Neusoft.HISFC.Models.Pharmacy 
{
    ...
    public class ApplyOut : Neusoft.HISFC.Models.IMA.IMAApplyBase
	{
        ...
        /// 配药操作人信息
        /// </summary>
        private Neusoft.HISFC.Models.Base.OperEnvironment compoundOper;
        ...
        /// 配药操作人信息
        /// </summary>
        public Neusoft.HISFC.Models.Base.OperEnvironment DISpensaryOper
        {
            get
            {
                if (compoundOper == null)
                {
                    compoundOper = new Neusoft.HISFC.Models.Base.OperEnvironment();
                }
                return compoundOper;
            }
            set
        ...
        public int ScanCodeQty { get; set; }
        ...
        /// 药追溯码 数量可多个
        /// </summary>
        public List<string> DrugTracCodgs = new List<string>();

        /// <summary>
        /// 追溯码采集状态 
        /// 0或空待采集 1采集中 2不用采集 3采集成功 4跳过采集 5采集失败
        /// </summary>
        ...
        /// 包装追溯码已采集数量
        /// </summary>
        public int AlreadyCollectQty { get; set; }

        /// <summary>
        /// 包装追溯码应采集数量
        /// </summary>
        public int NeedCollectQty { get; set; }

        /// <summary>
        /// 包装追溯码申诉数量
        /// </summary>
        public int AppealCollectQty { get; set; }


        /// <summary>
        /// 拆零追溯码已采集数量
        /// </summary>
        public int AlreadyCollectSpiltQty { get; set; }

        /// <summary>
        /// 拆零追溯码应采集数量
        /// </summary>
        public int NeedCollectSpiltQty { get; set; }

        /// <summary>
        /// 拆零追溯码申诉数量
        /// </summary>
        public int AppealCollectSpiltQty { get; set; }

        private string packConvertToSplitFlag = "0";

        /// <summary>
        /// 包装转拆零标志 0否 1是
        /// </summary>
        public string PackConvertToSplitFlag
        {
            get
            {
                return this.packConvertToSplitFlag;
            }
            set
            {
                this.packConvertToSplitFlag = value;
            }
        }

        private YbTraceCollectMain traceCollectMain = new YbTraceCollectMain();

        public YbTraceCollectMain TraceCollectMain
        {
            get
            {
                return this.traceCollectMain;
            }
            set
            {
                this.traceCollectMain = value;             
            }
        }
      
        /// <summary>
        /// 业务场景 见BusinessScenarioEnum
        /// </summary>
        public string BusinessScenario { get; set; }

        /// <summary>
        /// 系统来源 见SourceSystemEnum
        /// </summary>
        public string SourceSystem { get; set; }

        /// <summary>
        /// 采集类型 见CollectTypeEnum
        /// </summary>
        public string CollectType { get; set; }

        /// <summary>
        /// 业务场景 见BusinessTypeEnum
        /// </summary>
        public string BusinessType { get; set; }

        /// <summary>
        /// 是否需要采集追溯码标识 0不需要 1需要
        /// </summary>
