...
namespace Neusoft.HISFC.Models.Pharmacy
{
    ...
    private decimal newmyQualityFlag;	//新发药机数量
    private string  newmyQualityNum;	//新发药机单位
        ...
        /// <summary>
        /// 盘点明细表中当前发药机库存 即为字段other_adjust_numnew
        /// </summary>
        public decimal TableOtherAdjustQty { get; set; }


        /// <summary>
        /// 新发药机数量 实时取表FYJ_QTY中数据
        /// </summary>
        public decimal newOtherAdjustQty
        {
            get
            {
                return newmyQualityFlag;
            }
            set
            {
                newmyQualityFlag = value;
            }
        }
        /// <summary>
        /// 新发药机单位 实时取表FYJ_QTY中数据
        /// </summary>
        public string newOtherAdjust
        {
            get
            {
                return newmyQualityNum;
            }
            set
            {
                newmyQualityNum = value;
            }
        }
		/// <summary>
		/// 是否附加药品
