...
namespace Neusoft.HISFC.Models.Pharmacy 
{
    ...
    public class AdjustPrice : StorageBase 
	{
        ...
        private String aDJUST_BILL_CODE = string.Empty;


        /// <summary>
        /// 调价申请单据号
        /// </summary>
        public string ADJUST_BILL_CODE
        {
            get
            {
                return aDJUST_BILL_CODE;
            }
            set
            {
                aDJUST_BILL_CODE = value;
            }
        }
        ...
        private Decimal pre_Retailprice2;

        /// <summary>
        /// 调价前零差价
        /// </summary>
        public decimal Pre_Retailprice2
        {
            get
            {
                return this.pre_Retailprice2;
            }
            set
            {
                this.pre_Retailprice2 = value;
            }
        }
