...
namespace Neusoft.HISFC.Models.RADT
{
    ...
    public class PatientInfo : Neusoft.HISFC.Models.RADT.Patient 
	{
        ...
        /// 出生医学证明父母身份信息
        /// </summary>
        private Neusoft.HISFC.Models.RADT.ParentsInfo parentsInfo;
        /// <summary>
        /// 分值修改记录
        /// </summary>
        private Neusoft.HISFC.Models.HealthRecord.ICDScoreLog icdLog;
        /// <summary>
        /// 分值修改记录
        /// </summary>
        public Neusoft.HISFC.Models.HealthRecord.ICDScoreLog IcdLog
        {
            get { return icdLog; }
            set { icdLog = value; }
        }
        ...
        /// 补挂号标记
        /// </summary>
        private string regTag = string.Empty;
		...
		public Neusoft.HISFC.Models.SIInterface.SIMainInfo SIMainInfo
		{
			get
			{
                if (siMainInfo == null)
                {
                    siMainInfo = new Neusoft.HISFC.Models.SIInterface.SIMainInfo();
                }
        ...
        public Neusoft.HISFC.Models.Fee.Surety Surety
        {
            get
            {
                if (surety == null)
                {
                    surety = new Neusoft.HISFC.Models.Fee.Surety();
                }
                return surety;
            }
            set
        ...
        /// 出生医学证明父母身份信息
        /// </summary>
        public Neusoft.HISFC.Models.RADT.ParentsInfo ParentsInfo
        {
            get
            {
                if (parentsInfo == null)
        ...
        /// <summary>
        /// 是否日间手术标记 {7DD8FC90-9857-026E-E9C7-D7558D0054EF}
        /// </summary>
        public string DayOperationFlag { get; set; }

        /// <summary>
        /// 护士绿色通道入院标识 1是，0或其他否 {7DD8FC90-9857-026E-E9C7-D7558D0054EF}
        /// </summary>
        ...
        /// <summary>
        /// 召回类型（见com_dictionary中的recalltype）
        /// </summary>
        public string RecallType { get; set; }
        /// <summary>
        /// 病理放行标志：0 未放行；1 放行；空 不判断；
        /// </summary>
        public string PathologyPassFlag { get; set; }
        /// <summary>
        /// 医保登记类型 0本市  1省内  2省外
        /// </summary>
        public string MedicalRegisterType { get; set; }
        /// <summary>
        /// 参保地区划
        /// </summary>
        ...
        /// 康复付费住院标示0否1是
        /// </summary>
        public string HealFeeFlag { get; set; }
		#endregion
		...
		public new PatientInfo Clone()
        {
            ...
            if (this.IcdLog != null)
            {
                patientInfo.IcdLog = this.IcdLog.Clone();
            }
            if (this.posInfo != null)
            {
                patientInfo.PosInfo = this.posInfo.Clone();
            }
