...
namespace Neusoft.HISFC.Models.RADT
{
	...
	public class Patient : Neusoft.HISFC.Models.Base.Spell
	{
		...
		/// 患者各种编号
		/// </summary>
        private Neusoft.HISFC.Models.RADT.PID pid;
        ...
        /// 住址编码
        /// </summary>
        private string addressBusinessCode;
        ...
        // {BB517141-B5DC-4111-848A-98AF4F4ECF27} 增加配餐费功能
        /// <summary>
        /// 是否收配参费
        /// </summary>
        private bool isMeals;
        ...
        /// 门诊诊断编码
        /// </summary>
        private string clinicDiagnoseNo;
		...
		/// 开据医师
		/// </summary>
        private Neusoft.FrameWork.Models.NeuObject doctorReceiver;
		...
		/// 患者磁卡
		/// </summary>
        private Neusoft.HISFC.Models.RADT.Card card;
       ...
       /// </summary>
        ...
        /// 证件类型
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject idCardType;
		...
		/// 住址编码
		/// </summary>
		public string AddressBusinessCode
		{
			get
			{
                return this.addressBusinessCode;
			}
			set
			{
                this.addressBusinessCode = value;
			}
		}   
        ...
        // {BB517141-B5DC-4111-848A-98AF4F4ECF27}
        /// <summary>
        /// 是否收配餐费
        /// </summary>
        public bool IsMeals
        ...
        /// 门诊诊断编码
        /// </summary>
        public string ClinicDiagnoseNo
        {
            get
            {
                return this.clinicDiagnoseNo;
            }
            set
            {
                this.clinicDiagnoseNo = value;
            }
        }
...
//		}
        ...
        private List<Neusoft.HISFC.Models.Base.PactInfo> mutiPactInfo ;
        public List<Neusoft.HISFC.Models.Base.PactInfo> MutiPactInfo
        {
            get
            {
                return mutiPactInfo;
        ...
        /// 医保人员信息
        /// </summary>
        private Neusoft.HISFC.Models.SIInterface.SIPersonInfo siPerson ;//new  Neusoft.HISFC.Models.SIInterface.SIPersonInfo();
        /// <summary>
        /// 医保人员信息
        /// </summary>
        public Neusoft.HISFC.Models.SIInterface.SIPersonInfo SIPerson
        {
            get
            {
                if (siPerson == null)
                {
                    siPerson = new Neusoft.HISFC.Models.SIInterface.SIPersonInfo();
                }
                return siPerson;
            }
            set
		...
		public new Patient Clone()
		{
            ...
            List<Neusoft.HISFC.Models.Base.PactInfo> list = null;
            if (this.MutiPactInfo != null)
            {
                list = new List<PactInfo>();
                foreach (Neusoft.HISFC.Models.Base.PactInfo pactinfo in this.MutiPactInfo)
                {
        ...
        public Neusoft.HISFC.Models.Base.Spell RegularSpellCode
        {
            get
            {
                return null;
