...
namespace Neusoft.HISFC.Models.Operation
{
        ...
        Neusoft.HISFC.Models.Base.IDept
    {
        ...
        /// <summary>
        /// 手术人员的角色安排数组
        /// 数组中存的元素为Neusoft.HISFC.Models.Operator.ArrangeRole类型对象
        ...
        ///(数组元素为Neusoft.HISFC.Models.RADT.Diagnose Diagnose类型)
        ///</summary>
        ...
        ///<summary>
        ///助手医生
        ///（有可能是多人，因此，以一个动态数组来存储信息，数组元素为Neusoft.HISFC.Models.RADT.Person类型）
        ///</summary>
        ...
        /// <summary>
        /// 手术资料安排记录数组
        /// 元素为Neusoft.HISFC.Models.Operator.OpsApparatusRec类型
        /// </summary>		
        ...
        public void AddOperation(object operation, bool mainFlag)
        {
            ...
            else if (operation.GetType() == typeof(Neusoft.HISFC.Models.Fee.Item.Undrug))
            {
                ...
                opItem.OperationItem = (Neusoft.HISFC.Models.Base.Item)operation;//手术项目
                opItem.FeeRate = 1m;//比率
                opItem.Qty = 1;//数量
                opItem.StockUnit = (operation as Neusoft.HISFC.Models.Base.Item).PriceUnit;//单位
        ...
        public void AddRole(string id, string name, string foreFlag, EnumOperationRole operationRole, string supersedeDATE)
        {
            ...
            role.SupersedeDATE = Neusoft.FrameWork.Function.NConvert.ToDateTime(supersedeDATE);
        ...
        /// 是否术后计划转入ICU
        /// </summary>
        public string IsPlanToICU { get; set; }
