...
namespace Neusoft.HISFC.Models.Base
{
	...
	/// <summary>
	/// Neusoft.HISFC.Models.Order.SysClassEnumService<br></br>
	/// [功能描述: 医嘱开立项目类别]<br></br>
	/// [创 建 者: 孙晓华]<br></br>
    ...
    public class SysClassEnumService: EnumServiceBase {
		...
		static SysClassEnumService()
		{
            ...
            items[EnumSysClass.UO] = "手术";// Neusoft.FrameWork.Management.Language.Msg("手术");
		...
		/// 互斥
		/// </summary>
		protected Neusoft.HISFC.Models.Order.EnumMutex myMutex= Neusoft.HISFC.Models.Order.EnumMutex.None;
		#endregion
		...
		/// 互斥
		/// </summary>
		public Neusoft.HISFC.Models.Order.EnumMutex Mutex
		{
			get
			{
				return this.myMutex;
