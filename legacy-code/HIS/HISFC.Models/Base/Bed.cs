...
namespace  Neusoft.HISFC.Models.Base
{
	...
	public class Bed:Neusoft.FrameWork.Models.NeuObject ,ISort ,IValid
	{
		...
		/// 护理站
		/// </summary>
        private Neusoft.FrameWork.Models.NeuObject nurseStation;
		
		/// <summary>
		/// 床位状态
		/// </summary>
        private Neusoft.HISFC.Models.Base.BedStatusEnumService status;
		...
		/// 床位等级
		/// </summary>
        private Neusoft.FrameWork.Models.NeuObject grade;
		...
		/// 住院医生
		/// </summary>
        private Neusoft.FrameWork.Models.NeuObject admittingDoctor;
		
		/// <summary>
		/// 主治医生
		/// </summary>
        private Neusoft.FrameWork.Models.NeuObject attendingDoctor;
		
		/// <summary>
		/// 主任医生
		/// </summary>
        private Neusoft.FrameWork.Models.NeuObject consultingDoctor;
		
		/// <summary>
		/// 责任护士
		/// </summary>
        private Neusoft.FrameWork.Models.NeuObject admittingNurse;
