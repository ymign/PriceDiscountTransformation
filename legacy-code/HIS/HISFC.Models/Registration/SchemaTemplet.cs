...
namespace Neusoft.HISFC.Models.Registration
{
    ...
    public class SchemaTemplet : Neusoft.FrameWork.Models.NeuObject, Neusoft.HISFC.Models.Base.IValid
    {
        ...
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject doct;
        /// <summary>
        /// 出诊医生类型
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject doctType;
        /// <summary>
        /// 出诊午别
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject noon;
        /// <summary>
        /// 开始时间
        /// </summary>
        ...
        /// 停诊原因
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject stopReason;
        /// <summary>
        /// 操作环境
        /// </summary>
        ...
        /// 停止人
        /// </summary>
        private Neusoft.HISFC.Models.Base.OperEnvironment stop;

        /// <summary>
        /// 诊室
        /// </summary>
        private Neusoft.HISFC.Models.Nurse.Room room;

        /// <summary>
        /// 诊室
        /// </summary>
        public Neusoft.HISFC.Models.Nurse.Room Room
        {
            get
            {
                if (this.room == null)
                {
                    this.room = new Neusoft.HISFC.Models.Nurse.Room();
                }
                return room;
            }
            set { room = value; }
        ...
        /// 诊台
        /// </summary>
        private Neusoft.HISFC.Models.Nurse.Seat console;

        /// <summary>
        /// 诊台
        /// </summary>
        public Neusoft.HISFC.Models.Nurse.Seat Console
        {
            get
            {
                if (console == null)
                {
                    console = new Neusoft.HISFC.Models.Nurse.Seat();
                }
                return console;
            }
            set { console = value; }
        ...
        private string schemaDeptCode;
        private string schemaDeptName;
        ...
        public Neusoft.FrameWork.Models.NeuObject Dept
        {
            get {
                if (this.dept == null)
                {
                    this.dept = new Neusoft.FrameWork.Models.NeuObject();
                }
                return dept; }
            set { dept = value; }
        }
        ...
        public Neusoft.FrameWork.Models.NeuObject Doct
        {
            get {
                if (this.doct == null)
                {
                    this.doct = new Neusoft.FrameWork.Models.NeuObject();
                }
        ...
        public Neusoft.FrameWork.Models.NeuObject DoctType
        {
            get {
                ...
                {
                    this.doctType = new Neusoft.FrameWork.Models.NeuObject();
                }
        ...
        public Neusoft.FrameWork.Models.NeuObject Noon
        {
            get {
                if (this.noon == null)
                {
                    this.noon = new Neusoft.FrameWork.Models.NeuObject();
                }
                return noon; }
            set { noon = value; }
        }
        ...
        public Neusoft.FrameWork.Models.NeuObject StopReason
        {
            get {
                ...
                {
                    this.stopReason = new Neusoft.FrameWork.Models.NeuObject();
                }
        ...
        public Neusoft.HISFC.Models.Base.OperEnvironment Stop
        {
            get {
                if (this.stop == null)
                {
                    this.stop = new Neusoft.HISFC.Models.Base.OperEnvironment();
                }
                return this.stop; }
            set { this.stop = value; }
        }
        ...
        public string SchemaDeptCode
        {
            get { return schemaDeptCode; }
            set { schemaDeptCode = value; }
        }

        public string SchemaDeptName
        {
            get { return schemaDeptName; }
            set { schemaDeptName = value; }
        }
        #endregion
