...
namespace Neusoft.HISFC.Models.MedicalTraceCode
{
    ...
    /// 本类由代码生成器自动生成，请勿手动修改
    /// 由[少司命]定制专属守护
    /// 表名注释：拆零入库明细表(每个拆零子单位一条记录，含序号)
    /// 数据表名：yb_trace_inbound_detail
    /// 生成时间：2025-08-25 16:53:03
    /// </summary>
    public class YbTraceInboundDetail
    {
        /// <summary>
        /// 字段说明:唯一主键ID
        /// 数据类型:VARCHAR2
        ...
        /// <summary>
        /// 字段说明:入库主表[yb_trace_inbound_order]主键ID
        /// 数据类型:VARCHAR2
        /// 字段长度:50
        /// 是否可空:否
        /// 字段名称:inbound_id
        ...
        /// 字段长度:10
        /// 是否可空:否
        /// 字段名称:child_sequence_no
        /// </summary>
        public decimal ChildSequenceNo { get; set; }
