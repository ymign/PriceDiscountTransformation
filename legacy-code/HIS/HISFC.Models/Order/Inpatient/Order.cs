...
namespace Neusoft.HISFC.Models.Order.Inpatient
{
    ...
    public class Order:Neusoft.HISFC.Models.Order.Order
	{
        ...
        /// </summary>
        private Neusoft.HISFC.Models.Base.OperEnvironment dcNurse;
        ...
        /// 医嘱扩展表
        /// </summary>
        public OrderExtend OrdExtend
        {
            get
            {
                if (this.ordExtend == null)
                {
                    this.ordExtend = new OrderExtend();
                }
        ...
        public Neusoft.HISFC.Models.Base.OperEnvironment DCNurse
        {
            get
            {
                if (dcNurse == null)
                {
                    dcNurse = new Neusoft.HISFC.Models.Base.OperEnvironment();
                }
                return this.dcNurse;
            }
            set
