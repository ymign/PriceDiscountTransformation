...
namespace Neusoft.HISFC.Models.SIInterface {
    ...
    public class Compare : Neusoft.FrameWork.Models.NeuObject 
	{
        ...
        private Neusoft.FrameWork.Models.NeuObject feeProperty = new Neusoft.FrameWork.Models.NeuObject();

        /// <summary>
        /// 费用属性(珠海医保增加) 
        /// ID为代码,NAME为名称
        /// </summary>
        public Neusoft.FrameWork.Models.NeuObject FeeProperty
        {
            get
            {
        ...
        /// 限制用药
        /// </summary>
        private string limitDrug = string.Empty;
