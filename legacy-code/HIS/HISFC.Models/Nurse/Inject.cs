...
namespace Neusoft.HISFC.Models.Nurse
{
	...
	public class Inject : Neusoft.FrameWork.Models.NeuObject
	{
		...
		/// 是否皮试
		/// </summary>
        private Neusoft.HISFC.Models.Order.EnumHypoTest hypotest;
        ...
        /// 患者费用项目信息
        /// </summary>
        private Neusoft.HISFC.Models.Fee.Outpatient.FeeItemList item;
        
        /// <summary>
        /// 配药人信息36.37
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject mixOperInfo;
        
		/// <summary>
		/// 注射人信息39.40
		/// </summary>
        private Neusoft.FrameWork.Models.NeuObject injectOperInfo;

		/// <summary>
		/// 拔针人信息47
		/// </summary>
        private Neusoft.FrameWork.Models.NeuObject stopOper;
        ...
        /// 登记操作环境
        /// </summary>
        private Neusoft.HISFC.Models.Base.OperEnvironment booker;
        ...
        public Neusoft.HISFC.Models.Base.OperEnvironment Booker
        {
            get
            {
                if (booker == null)
                {
                    booker = new Neusoft.HISFC.Models.Base.OperEnvironment();
                }
                return this.booker;
            }
            set
        ...
        public Neusoft.HISFC.Models.Registration.Register Patient
        {
            get
            {
                if (patient == null)
                {
                    patient = new Neusoft.HISFC.Models.Registration.Register();
                }
                return this.patient;
            }
            set
        ...
        public Neusoft.FrameWork.Models.NeuObject MixOperInfo
        {
            get
            {
                if (mixOperInfo == null)
                {
                    mixOperInfo = new Neusoft.FrameWork.Models.NeuObject();
                }
		...
		/// 是否皮试26
		/// </summary>
        public Neusoft.HISFC.Models.Order.EnumHypoTest Hypotest
		{
			get
			{
                if (hypotest == null)
                {
                    hypotest = Neusoft.HISFC.Models.Order.EnumHypoTest.FreeHypoTest;
                }
		...
		public Neusoft.FrameWork.Models.NeuObject InjectOperInfo
        {
            get
            {
                ...
                {
                    injectOperInfo = new Neusoft.FrameWork.Models.NeuObject();
                }
		...
		public Neusoft.FrameWork.Models.NeuObject StopOper
        {
            get
            {
                if (stopOper == null)
                {
                    stopOper = new Neusoft.FrameWork.Models.NeuObject();
                }
