...
namespace Neusoft.HISFC.Models.HealthRecord
{
    ...
    public class Base //: Neusoft.FrameWork.Models.NeuObject
    {
        ...
        /// 保存操作者
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject saveOperation = new NeuObject();


        /// <summary>
        /// 最后保存日期
        /// </summary>
        private System.DateTime lastSaveTime;
        ...
        ///  add by chengym 2012-1-31
        /// </summary>
        private Neusoft.FrameWork.Models.NeuObject dutyNurse =new NeuObject();
        ...
        private string diag_Flag=string.Empty;
        ...
        /// 保存操作者
        /// </summary>
        public Neusoft.FrameWork.Models.NeuObject SaveOperation
        {
            get
            {
        ...
        ///  add by chengym 2012-1-31
        /// </summary>
        public Neusoft.FrameWork.Models.NeuObject DutyNurse
        {
            get
            {
        ...
        public new Base Clone()
        {
            ...
            b.saveOperation = this.saveOperation.Clone();
