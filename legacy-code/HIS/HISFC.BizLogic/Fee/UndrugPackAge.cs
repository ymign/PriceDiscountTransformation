...
namespace Neusoft.HISFC.BizLogic.Fee
{
	...
	public class UndrugPackAge: Neusoft.FrameWork.Management.Database 
	{
        ...
        /// <returns></returns>
        public Neusoft.HISFC.Models.Fee.Item.UndrugComb GetUndrugComb(string packageCode, string itemCode)
        {
            Neusoft.HISFC.Models.Fee.Item.UndrugComb info = null;
            string strSql = "";
        ...
        /// <param name="itemCode"></param>
        /// <returns></returns>
        public Neusoft.HISFC.Models.Fee.Item.UndrugComb GetUndrugCombAll(string packageCode, string itemCode)
        {
            Neusoft.HISFC.Models.Fee.Item.UndrugComb info = null;
            string strSql = "";
            if (this.Sql.GetCommonSql("Fee.undrugzt.GetUndrugztinfoByKey", ref strSql) == -1)
