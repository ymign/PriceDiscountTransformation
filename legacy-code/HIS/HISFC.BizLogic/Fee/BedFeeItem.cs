...
namespace Neusoft.HISFC.BizLogic.Fee
{
	...
	public class BedFeeItem : Neusoft.FrameWork.Management.Database
	{
        ...
        /// <param name="bedFeeItem">床位费实体</param>
        /// <returns></returns>
        private string[] GetBedFeeItemParmsForPatient(Neusoft.HISFC.Models.Fee.BedFeeItem bedFeeItem)
        {
            string[] parms = {   
                                 bedFeeItem.PrimaryKey,
                                 bedFeeItem.FeeGradeCode,
        ...
        /// <returns></returns>
        public Neusoft.HISFC.Models.Fee.BedFeeItem QueryBedGradeForPatient(string inpatientNO, string bedNO, string bedGradeID)
        {
            string sql = string.Empty; //查询SQL语句
            ...
            Neusoft.HISFC.Models.Fee.BedFeeItem bedFeeItem = null;
            try
            {
                //循环读取数据
                if (this.Reader.Read())
                {
                    bedFeeItem = new Neusoft.HISFC.Models.Fee.BedFeeItem();
        ...
        /// <param name="bedFeeItem">床位信息实体</param>
        /// <returns>成功 1 失败 -1 没有删除到记录 0</returns>
        public int InsertBedFeeItemForPatient(Neusoft.HISFC.Models.Fee.BedFeeItem bedFeeItem)
        {
            string sql = string.Empty; //插入fin_com_bedfeegrade表的SQL语句
        ...
        /// <param name="bedFeeItem">床位信息实体</param>
        /// <returns>成功 1 失败 -1 没有删除到记录 0</returns>
        public int UpdateBedFeeItemForPatient(Neusoft.HISFC.Models.Fee.BedFeeItem bedFeeItem)
        {
