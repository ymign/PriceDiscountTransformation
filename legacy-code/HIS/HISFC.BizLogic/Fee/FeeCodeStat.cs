...
namespace Neusoft.HISFC.BizLogic.Fee
{
	...
	public class FeeCodeStat : Neusoft.FrameWork.Management.Database
	{
        ...
        /// <returns></returns>
        public List<Neusoft.HISFC.Models.Fee.FeeCodeStat> QueryFeeStatNameByReportCode(string reportCode)
        {
            string sql = string.Empty; //查询SQL语句
            ...
            try
            {
                ...
                List<Neusoft.HISFC.Models.Fee.FeeCodeStat> lstFeeStat = new List<Neusoft.HISFC.Models.Fee.FeeCodeStat>();
                //循环读取数据
                while (this.Reader.Read())
                {
                    Neusoft.HISFC.Models.Fee.FeeCodeStat feeCodeStat = new Neusoft.HISFC.Models.Fee.FeeCodeStat();
                    ...
                    feeCodeStat.SortID = Neusoft.FrameWork.Function.NConvert.ToInt32(this.Reader[3].ToString());
