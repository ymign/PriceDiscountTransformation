...
//		}
		...
		/// <param name="ClinicReg">产检记账金额</param>
		...
		/// <param name="InHosAndClinicTot">住院和门诊总记账费用</param>
		/// <param name="InhosAndClinicAbove">总费用 符合规定一万元以上记账</param>
		/// <param name="InHosAndClinicBelow">总费用 符合规定一万元以下记账</param>
		...
		public int GetOldFeeTotal(string Begin,string End,string ItemType,string SpecalItem , decimal StandFee ,out decimal ApplyNum,out decimal childbearing ,out decimal ClinicTot,out decimal ClinicPay,out decimal ClinicReg,out decimal InHosTot,out decimal InHosPay,out decimal InHosAbove,out decimal InHosBelow,out decimal InHosAndClinicTot,out decimal InhosAndClinicAbove,out decimal InHosAndClinicBelow,out decimal AllTot,out decimal StandFeeTot)
		{
			try
			{
				...
				InHosAndClinicTot = 0;//住院和门诊记账总费用 
        ...
        public int QueryInvoiceList(string queryType, string value, string begin, string end, ref DataSet dsResult)
        {
            ...
            if (this.Sql.GetCommonSql("Neusoft.ClinicFee.QueryClinicInvoice", ref sqlStr) == -1)
            {
                this.Err = "查找索引为Neusoft.ClinicFee.QueryClinicInvoice的SQL语句失败!";
                return -1;
            }
            ...
            try
            {
                ...
                if (this.ExecQuery(sqlStr, ref dsResult) == -1)
                {
                    this.Err = "执行Neusoft.ClinicFee.QueryClinicInvoice的SQL语句失败!";
                    return -1;
                }
            }
            catch (Exception ex)
        ...
        public int QueryInvoiceFeedetail(string invoiceNo, ref DataSet dsResult)
        {
            ...
            if (this.Sql.GetCommonSql("Neusoft.ClinicFee.QueryFeedetailByInvoiceForPrint", ref sqlStr) == -1)
            {
                this.Err = "查找索引为Neusoft.ClinicFee.QueryFeedetailByInvoiceForPrint的SQL语句失败!";
                return -1;
            }
            ...
            try
            {
                ...
                if (this.ExecQuery(sqlStr, ref dsResult) == -1)
                {
                    this.Err = "执行Neusoft.ClinicFee.QueryFeedetailByInvoiceForPrint的SQL语句失败!";
                    return -1;
                }
            }
            catch (Exception ex)
        ...
        public int QueryItemReportForOutPatient(string begin, string end, string itemCode, string itemFlag, ref DataSet dsResult)
        {
            ...
            if (itemFlag == "0")
            {
                sqlID = "Neusoft.QiaoTou.OutPatientFeeReport.QueryItemList";
            }
            else if (itemFlag == "1")
            {
                sqlID = "Neusoft.QiaoTou.OutPatientFeeReport.QueryDrugList";
            }
        ...
        public int QueryItemReportForInPatient(string begin, string end, string itemCode, string itemFlag, ref DataSet dsResult)
        {
            ...
            if (itemFlag == "0")
            {
                sqlID = "Neusoft.QiaoTou.InPatientFeeReport.QueryItemList";
            }
            else if (itemFlag == "1")
            {
                sqlID = "Neusoft.QiaoTou.InPatientFeeReport.QueryDrugList";
            }
        ...
        public int QueryOutPatientInvoiceInfoByDate(string cardNO, string beginDate, string endDate, ref DataSet dsResult)
        {
            dsResult = new DataSet();
            string sqlStr = "";
            if (this.Sql.GetCommonSql("Neusoft.OutPatient.GetPatientInvoiceInfoByDate", ref sqlStr) == -1)
            {
                this.Err = "查询索引为Neusoft.OutPatient.GetPatientInvoiceInfoByDate的SQL语句失败!";
                return -1;
            }
            ...
            try
            {
                ...
                if (this.ExecQuery(sqlStr, ref dsResult) == -1)
                {
                    this.Err = "执行索引为Neusoft.OutPatient.GetPatientInvoiceInfoByDate的SQL语句失败!";
                    return -1;
                }
            }
            catch (Exception ex)
            {
                this.Err = "执行索引为Neusoft.OutPatient.GetPatientInvoiceInfoByDate的SQL语句失败!" + ex.Message;
                return -1;
            }
        ...
        public int QueryOutPatientInvoiceDetailByInvoiceNo(string invoiceNO, ref DataSet dsResult)
        {
            ...
            if (this.Sql.GetCommonSql("Neusoft.OutPatient.GetPatientInvoiceDetailByInvoiceNO", ref sqlStr) == -1)
            {
                this.Err = "查找索引为Neusoft.OutPatient.GetPatientInvoiceDetailByInvoiceNO的SQL语句失败!";
                return -1;
            }
            ...
            try
            {
                ...
                if (this.ExecQuery(sqlStr, ref dsResult) == -1)
                {
                    this.Err = "执行索引为Neusoft.OutPatient.GetPatientInvoiceDetailByInvoiceNO的sql语句失败!";
                    return -1;
                }
            }
            catch (Exception ex)
            {
                this.Err = "执行索引为Neusoft.OutPatient.GetPatientInvoiceDetailByInvoiceNO的SQL语句失败!" + ex.Message;
                return -1;
            }
        ...
        public ArrayList GetDeptByItemQueryType(string type)
        {
            ...
            if (this.Sql.GetCommonSql("Neusoft.WorkLoad.GetDeptByItemQuery", ref querySql) == -1)
            {
                this.Err = "获取Sql语句出错,索引号:Neusoft.WorkLoad.GetDeptByItemQuery";
                WriteErr();
                return null;
            }
        ...
        public int QueryItemQueryMend(string deptCode, string queryType, ref DataSet ds)
        {
            ...
            if (this.Sql.GetCommonSql("Neusoft.WorkLoad.GetItemQueryInfoByDeptQueryType", ref querySql) == -1)
            {
                this.Err = "获取Sql语句出错,索引号:Neusoft.WorkLoad.GetItemQueryInfoByDeptQueryType";
                WriteErr();
                ds = null;
                return -1;
            }
        ...
        /// <returns></returns>
        public int InsertItemInfoAment(Neusoft.FrameWork.Models.NeuObject ament)
        {
            if (ament == null)
            {
                return 0;
            ...
            if (this.Sql.GetCommonSql("Neusoft.WorkLoad.InsertItemQueryInfo", ref insertSql) == -1)
            {
                this.Err = "获取Sql语句出错,索引号:Neusoft.WorkLoad.InsertItemQueryInfo";
                WriteErr();
                return -1;
            }
        ...
        /// <returns></returns>
        public int UpdateItemInfoAment(Neusoft.FrameWork.Models.NeuObject amentObj)
        {
            if (amentObj == null)
            {
                this.Err = "更新实体为空!";
            ...
            if (this.Sql.GetCommonSql("Neusoft.WorkLoad.UpdateItemQueryInfo", ref updateSql) == -1)
            {
                this.Err = "索引更新语句出错,索引号:Neusoft.WorkLoad.UpdateItemQueryInfo";
                WriteErr();
                return -1;
            }
        ...
        public int DeleteItemInfoAment(Neusoft.FrameWork.Models.NeuObject amentObj)
        {
            ...
            string deleteSql = "";
            if (this.Sql.GetCommonSql("Neusoft.WorkLoad.DeleteItemQueryInfo", ref deleteSql) == -1)
            {
                this.Err = "获取Sql语句失败,索引号:Neusoft.WorkLoad.DeleteItemQueryInfo";
                WriteErr();
                return -1;
            }
        ...
        {
            string deleteSql = "";
            if (this.Sql.GetCommonSql("Neusoft.WorkLoad.DeleteItemQueryList", ref deleteSql) == -1)
            {
                this.Err = "Neusoft.WorkLoad.DeleteItemQueryList";
                WriteErr();
                return -1;
            }
        ...
        {
            string deleteSql = "";
            if (this.Sql.GetCommonSql("Neusoft.WorkLoad.DeleteItemQueryConst", ref deleteSql) == -1)
            {
                this.Err = "获取Sql语句出错,索引号:Neusoft.WorkLoad.DeleteItemQueryConst";
                WriteErr();
                return -1;
            }
        ...
        /// <returns></returns>
        public int insertConstSub(string type, Neusoft.FrameWork.Models.NeuObject obj)
        {
            string insertSql = "";
            string getseqSql = "SELECT SEQ_FIN_COM_ITEMQUERY.NEXTVAL FROM DUAL";
            string code = string.Empty;
            int sortid = Neusoft.FrameWork.Function.NConvert.ToInt32(obj.ID);
            ...
            if (this.Sql.GetCommonSql("Neusoft.WorkLoad.Const.Insert", ref insertSql) == -1)
            {
                this.Err = "插入常数失败,查询索引号出错,Neusoft.WorkLoad.Const.Insert";
                WriteErr();
                return -1;
            }
            try
