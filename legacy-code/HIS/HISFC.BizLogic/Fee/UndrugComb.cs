...
namespace Neusoft.HISFC.BizLogic.Fee
{
    ...
    public class UndrugComb : Neusoft.FrameWork.Management.Database
    {
        ...
        public Neusoft.HISFC.Models.Fee.Item.UndrugComb GetUndrugCombValidByCode(string undrugCombCode)
        {
            ...
            return undrugCombs[0] as Neusoft.HISFC.Models.Fee.Item.UndrugComb;
        }
        ...
        public Neusoft.HISFC.Models.Fee.Item.UndrugComb GetValidUndrugzt(string ztID)
        {
            string sql = "";
            string strSql = "";
