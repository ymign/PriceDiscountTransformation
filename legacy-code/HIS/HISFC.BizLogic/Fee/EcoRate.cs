...
namespace Neusoft.HISFC.BizLogic.Fee
{
    ...
    public class EcoRate : Neusoft.FrameWork.Management.Database
    {
        ...
        public int GetRateByItem(Neusoft.HISFC.Models.Fee.Outpatient.EcoRate ecoRate)
        {
            ...
            // 获取SQL语句
            //
            this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.EcoRate.GetRate.Select", ref this.SELECT);
            if (this.intReturn == -1)
            {
                this.Err = "获取SQL语句失败!";
                return -1;
            }
            this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.EcoRate.GetRateByItem.Where", ref this.WHERE);
            if (this.intReturn == -1)
            {
                this.Err = "获取SQL语句失败!";
                return -1;
        ...
        public int GetRateByMinFee(Neusoft.HISFC.Models.Fee.Outpatient.EcoRate ecoRate)
        {
            ...
            this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.EcoRate.GetRateByMinFee.Where", ref this.WHERE);
            if (this.intReturn == -1)
            {
                this.Err = "获取SQL语句失败!";
                return -1;
        ...
        public int GetRateByClass(Neusoft.HISFC.Models.Fee.Outpatient.EcoRate ecoRate)
        {
            ...
            this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.EcoRate.GetRateByClass.Where", ref this.WHERE);
            if (this.intReturn == -1)
            {
                this.Err = "获取SQL语句失败!";
                return -1;
        ...
        public int CreateEcoRate(Neusoft.HISFC.Models.Fee.Outpatient.EcoRate ecoRate)
        {
            ...
            // 获取SQL语句
            //
            this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.EcoRate.CreateEcoRate", ref this.SQL);
            if (this.intReturn == -1)
            {
        ...
        public int DeleteEcoRate(Neusoft.HISFC.Models.Fee.Outpatient.EcoRate ecoRate)
        {
            ...
            // 获取SQL语句
            //
            this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.EcoRate.DeleteEcoRate.Delete", ref this.SELECT);
            if (this.intReturn == -1)
            {
                this.Err = "获取SQL语句Neusoft.HISFC.BizLogic.Fee.EcoRate.DeleteEcoRate.Delete失败!";
            }
            this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.EcoRate.DeleteEcoRate.Where", ref this.WHERE);
            if (this.intReturn == -1)
            {
        ...
        public int UpdateEcoRate(Neusoft.HISFC.Models.Fee.Outpatient.EcoRate ecoRate)
        {
            ...
            // 获取SQL语句
            //
            this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.EcoRate.UpdateEcoRate.Update", ref this.SELECT);
            if (this.intReturn == -1)
            {
        ...
        public int GetAllEcoRate(string ecoCode, string typeCode, ArrayList alEcoRate)
        {
            ...
            {
                this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.EcoRate.GetAll.Where1", ref this.WHERE);
            }
            else
            {
                this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.EcoRate.GetAll.Where", ref this.WHERE);
            }
            if (this.intReturn == -1)
            {
                this.Err = "获取SQL语句失败!";
        ...
        public int GetPermitItems(System.Data.DataSet dataSet)
        {
            ...
            // 获取SQL语句
            //
            this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.GetPermitItems", ref this.SELECT);
            if (this.intReturn == -1)
            {
        ...
        public int GetPermitItemsWorkload(System.Data.DataSet dataSet)
        {
            ...
            // 获取SQL语句
            //
            this.intReturn = this.Sql.GetCommonSql("Neusoft.HISFC.BizLogic.Fee.GetPermitItems.Workload", ref this.SELECT);
            if (this.intReturn == -1)
            {
                this.Err = "获取SQL语句Neusoft.HISFC.BizLogic.Fee.GetPermitItems失败!";
                return -1;
