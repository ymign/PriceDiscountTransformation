...
namespace Neusoft.HISFC.BizLogic.Pharmacy
{
    ...
    public class Constant : DataBase
    {
        ...
        /// <param name="company">公司信息</param>
        /// <returns>0没有更新 1成功 -1失败</returns>
        public int InsertCompany(Neusoft.HISFC.Models.Pharmacy.Company company,out string companyID)
        {
            string strSQL = "";
            companyID = "";
            if (this.GetSQL("Pharmacy.Constant.InsertCompany", ref strSQL) == -1)
        ...
        private string[] myGetDrugStencilParam(Neusoft.HISFC.Models.Pharmacy.DrugStencil drugStencil)
        {
            ...
            if (drugStencil.OpenType.ID == Neusoft.HISFC.Models.Pharmacy.EnumDrugStencil.Custom.ToString())
            {
                ...
                while (this.Reader.Read())
                {
                    ...
                    switch (stencilType)
                    {
                        ...
                        case "Apply":
                            ...
                            break;
                        default:
                            drugStencil.OpenType.ID = Neusoft.HISFC.Models.Pharmacy.EnumDrugStencil.Custom.ToString(); ;
        ...
        /// <returns></returns>
        public DataTable GetSpeDruCompareDepOrPerson(Neusoft.HISFC.Models.Pharmacy.EnumDrugSpecialType speType)
        {
        ...
        /// </summary>
        /// <param name="speType"></param>
        public int DelSpeDrugDepOrPerCompare(Neusoft.HISFC.Models.Pharmacy.EnumDrugSpecialType speType)
        {
            string strSql = string.Empty;
        ...
        /// <returns></returns>
        public int InsertSpeDrugDepOrPerCompare(Neusoft.HISFC.Models.Pharmacy.DrugSpecial drugSpe)
        {
            string strSql = string.Empty;
        ...
        /// </summary>
        /// <returns></returns>
        public int DelSpeDrugCompare(Neusoft.HISFC.Models.Pharmacy.DrugSpecial drugSpe)
        {
            string strSql = string.Empty;
        ...
        public ArrayList QueryAllSpeDrugCode()
        {
            ...
            try
            {
                while (this.Reader.Read())
                {
                    ...
                    item.Qty = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.Reader[3]);//用来存储上限量
                    item.OnceDose = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.Reader[7]);//用来存储追加量{07AA9FFA-BC72-4443-99F2-85541A03E198}
        ...
        public ArrayList QueryAllSpeDrugPerAndDep()
        {
            ...
            try
            {
                while (this.Reader.Read())
                {
                    ...
                    empl.Memo = this.Reader[7].ToString();
                    al.Add(empl);
                }
                return al;
            }
        ...
        /// <returns></returns>
        public bool MachineFStore(string deptCode)
        {
            try
            {
                string sql = @"  select a.name from com_dictionary a
          where a.type='PhaChcekMachine'
           and a.code='{0}'
           and a.valid_state='1'";

                sql = string.Format(sql, deptCode);

                string r = this.ExecSqlReturnOne(sql);
                return Neusoft.FrameWork.Function.NConvert.ToBoolean(r);
