...
namespace Neusoft.HISFC.BizLogic.Registration
{
	...
	public class SchemaTemplet:Neusoft.FrameWork.Management.Database
	{
        ...
        public int Insert(Neusoft.HISFC.Models.Registration.SchemaTemplet templet)
        {
            ...
            if (this.Sql.GetCommonSql("Registration.Templet.Insert.WithSchemaDept", ref sql) == -1)
                return -1;
            ...
            try
            {
                sql = string.Format(sql, 
                    ...
                    templet.TelQuota,
                    templet.SpeQuota,
                    Neusoft.FrameWork.Function.NConvert.ToInt32(templet.IsAppend),
                    ...
                    templet.SchemaDeptCode,
                    templet.SchemaDeptName
                    );
            }
            catch (Exception e)
            {
                this.Err = "[Registration.Templet.Insert.WithSchemaDept]格式不匹配!" + e.Message;
        ...
        public ArrayList Query(Neusoft.HISFC.Models.Base.EnumSchemaType schemaType, DayOfWeek week, string DeptID)
        {
            ...
            if (this.Sql.GetCommonSql("Registration.Templet.Query.WithSchemaDept", ref sql) == -1)
                return null;
		...
		public ArrayList Query(Neusoft.HISFC.Models.Base.EnumSchemaType schemaType,DayOfWeek week,bool IsValid)
		{
            ...
            if (this.Sql.GetCommonSql("Registration.Templet.Query.WithSchemaDept", ref sql) == -1) return null;
		...
		private ArrayList QueryBase(string sql)
		{
			...
			try
			{
				while(this.Reader.Read())
				{
                    ...
                    {
                         schemaTemplet.SchemaDeptCode = Reader[29].ToString();
                         schemaTemplet.SchemaDeptName = Reader[30].ToString();
                    }
