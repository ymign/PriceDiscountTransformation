		...
		public int Insert(Neusoft.HISFC.Models.Registration.RegLevel regLevel)
		{
			...
			try
			{
				sql=string.Format(sql,regLevel.ID,regLevel.Name,regLevel.UserCode,regLevel.SortID.ToString(),
                    ...
                    /*{156C449B-60A9-4536-B4FB-D00BC6F476A1}*/, Neusoft.FrameWork.Function.NConvert.ToInt32(regLevel.IsEmergency));
			}
			catch(Exception e)
			{
		...
		private ArrayList queryBase(string sql)
		{
			...
			try
			{
				...
				while(this.Reader.Read())
				{
                    ...
                    this.regLvl.IsEmergency = Neusoft.FrameWork.Function.NConvert.ToBoolean(this.Reader[13].ToString());
