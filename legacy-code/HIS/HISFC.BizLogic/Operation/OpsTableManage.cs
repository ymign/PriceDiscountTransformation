	...
	public class OpsTableManage : Neusoft.FrameWork.Management.Database 
	{
            ...
            foreach (Neusoft.HISFC.Models.Operation.OpsTable thisOpsTable in tables)
            {
                ...
                try
                {
                    strSql = string.Format(strSql, thisOpsTable.ID, thisOpsTable.Name,
                        ...
                        thisOpsTable.Room.ID, thisOpsTable.Memo, thisOpsTable.User.ID.ToString(), Neusoft.FrameWork.Function.NConvert.ToInt32(thisOpsTable.IsValid).ToString());
                }
                catch (Exception ex)
                {
                    this.Err = ex.Message;
        ...
        public ArrayList GetOpsState(DateTime dateTime)
        {
            ...
            try
            {
                while (this.Reader.Read())
                {
                    Neusoft.FrameWork.Models.NeuObject opsState = new Neusoft.FrameWork.Models.NeuObject();
        ...
        /// <returns></returns>
        public int UpdateOpsState(Neusoft.HISFC.Models.Operation.OperationAppllication opsInfo,string state)
        {
            string strSql = string.Empty;
        ...
        /// <param name="state"></param>
        /// <returns></returns>
        public int InsertOpsState(Neusoft.HISFC.Models.Operation.OperationAppllication opsInfo, string state)
        {
            string strSql = string.Empty;
