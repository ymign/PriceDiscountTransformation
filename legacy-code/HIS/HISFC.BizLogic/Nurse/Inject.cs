		...
		public ArrayList myGetInfo(string SQLString) 
		{
			...
			try 
			{
				while (this.Reader.Read())  
				{
                    ...
                    info.Hypotest = (Neusoft.HISFC.Models.Order.EnumHypoTest)Neusoft.FrameWork.Function.NConvert.ToInt32(this.Reader[25]);
                    ...
                    info.Item.Days = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.Reader[49].ToString());
					#endregion
					al.Add(info);
				}
			}//抛出错误
