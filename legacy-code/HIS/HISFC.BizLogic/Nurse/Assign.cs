...
namespace Neusoft.HISFC.BizLogic.Nurse
{
    ...
    public class Assign : Neusoft.FrameWork.Management.Database
    {
        ...
        private ArrayList Query(string sql)
        {
            ...
            try
            {
                while (this.Reader.Read())
                {
                    ...
                    //是否急诊
                    this.assign.Register.DoctorInfo.Templet.RegLevel.IsEmergency = Neusoft.FrameWork.Function.NConvert.ToBoolean(this.Reader[9].ToString());
                    //是否预约
                    ...
                    {
                        assign.Register.InputOper.OperTime = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[28]);
                    }
                    #endregion
        ...
        /// <returns></returns>
        public Neusoft.HISFC.Models.Nurse.Assign QueryLastAssignPatient(string nuerseID, DateTime today, string queueID, string status)
        {
            ArrayList al = this.QueryAssignBase("Nurse.Assign.Query.LastAssign", nuerseID, today, queueID, Neusoft.FrameWork.Function.NConvert.ToInt32(status));
            if (al != null && al.Count > 0)
            {
                return al[0] as Neusoft.HISFC.Models.Nurse.Assign;
            }
            return null;
        }
        ...
        /// <param name="status"></param>
        /// <returns></returns>
        public ArrayList BatchQuery(string nurseID, DateTime today, string queueID, params Neusoft.HISFC.Models.Nurse.EnuTriageStatus[] status)
        {
            string sql = "", where = "";
        ...
        protected ArrayList QueryAssReg(string sql)
        {
            ...
            try
            {
                while (this.Reader.Read())
                {
                    ...
                    assign.Register.IsTriage = Neusoft.FrameWork.Function.NConvert.ToBoolean(this.Reader[43].ToString());
                    if (this.Reader.FieldCount >= 45)
                        assign.Register.OrderNO = Neusoft.FrameWork.Function.NConvert.ToInt32(Reader[44].ToString());
                    ...
                    if (this.Reader.FieldCount >= 48)
                        assign.Register.InputOper.OperTime = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[47]);
                    if (this.Reader.FieldCount >= 49)
                        assign.Register.Greenway = Reader[49].ToString();
                    al.Add(this.assign);
                }
        ...
        /// <returns></returns>
        public int Update(Neusoft.HISFC.Models.Nurse.Assign assign)
        {
            string sql = "";
        ...
        public int Insert(Neusoft.HISFC.Models.Nurse.Assign assign)
        {
            ...
            try
            {
                sql = string.Format(sql,
                        ...
                        Neusoft.FrameWork.Function.NConvert.ToInt32(assign.Register.DoctorInfo.Templet.RegLevel.IsEmergency),
                        Neusoft.FrameWork.Function.NConvert.ToInt32(assign.Register.RegType),
        ...
        /// <param name="assign"></param>
        /// <returns></returns>
        public int UpdateAssignFlag(string clinicCode, string doctID, Neusoft.HISFC.Models.Nurse.EnuTriageStatus assign)
        {
            string sql = "";
        ...
        /// <param name="doctID"></param>
        /// <returns></returns>
        public int UpdateAssignFlag(int assignflag, Neusoft.FrameWork.Models.NeuObject dept, string doctID, string seeDate, int nowAssignflag)
        {
            string sql = "";
        ...
        private ArrayList QuerySimpleRegInfo(string whereIndex, params string[] args)
        {
            ...
            try
            {
                ...
                Neusoft.HISFC.Models.Nurse.Assign assignObj = null;
                while (this.Reader.Read())
                {
                    assignObj = new Neusoft.HISFC.Models.Nurse.Assign();
                    ...
                    assignObj.SeeNO = Neusoft.FrameWork.Function.NConvert.ToInt32(Reader[4]);//看诊序号
                    ...
                    assignObj.TriageStatus = (Neusoft.HISFC.Models.Nurse.EnuTriageStatus)
                                                    Neusoft.FrameWork.Function.NConvert.ToInt32(this.Reader[10].ToString());
                    assignObj.Register.PID.CardNO = Reader[11].ToString();//病历号
                    assignObj.Register.OrderNO = Neusoft.FrameWork.Function.NConvert.ToInt32(Reader[12].ToString());//病历号
                    ...
                    assignObj.Register.InputOper.OperTime = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[15]);
                    assignObj.Register.DoctorInfo.SeeDate = Neusoft.FrameWork.Function.NConvert.ToDateTime(Reader[16]);
                    assignObj.Register.RegType = (Neusoft.HISFC.Models.Base.EnumRegType)Neusoft.FrameWork.Function.NConvert.ToInt32(this.Reader[17].ToString());
                    al.Add(assignObj);
                }
