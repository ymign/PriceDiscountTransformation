...
namespace Neusoft.HISFC.BizLogic.Manager
{
    ...
    /// Frequency 的摘要说明。
    /// </summary>
    public class Frequency : DataBase, Neusoft.HISFC.Models.Base.IManagement
    {
        public Frequency()
        {
            //
        ...
        private ArrayList myList(string sql)
        {
            ...
            try
            {
                while (this.Reader.Read())
                {
                    ...
                    // {5C830CF4-4451-4f85-BB60-335F22FB329C} 临时医嘱过滤频次
                    if (this.Reader.FieldCount > 11)
                    {
                        obj.IsUserForInpatientLZ = Neusoft.FrameWork.Function.NConvert.ToBoolean(this.Reader[11]); //English_AB
                        obj.IsUseForInpatientCZ = Neusoft.FrameWork.Function.NConvert.ToBoolean(this.Reader[12]); //English_AB
                    }
                    al.Add(obj);
                }
                return al;
