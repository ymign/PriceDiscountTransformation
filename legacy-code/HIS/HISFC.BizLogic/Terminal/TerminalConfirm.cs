...
namespace Neusoft.HISFC.BizLogic.Terminal
{
    ...
    public class TerminalConfirm : Neusoft.FrameWork.Management.Database
    {
        ...
        {
            Neusoft.FrameWork.Management.ControlParam controlerFunction = new Neusoft.FrameWork.Management.ControlParam();
            int intDays = 0;
        ...
        /// <param name="applyList">返回的明细</param>
        /// <returns></returns>
        public int QueryByInpaRetientmList(string inpatientNO, string operDept, ref ArrayList applyList)
        {
            // SQL语句
            string sql = "";
            //
            // 获取SQL语句
            //
            if (this.Sql.GetSql("Terminal.TerminalConfirm.QueryByInpaRetientmList", ref sql) == -1)
            {
                this.Err = "获取SQL语句Terminal.TerminalConfirm.QueryByInpaRetientmList失败";
                return -1;
            }
            // 匹配执行SQL语句
            try
            ...
            this.FillInpatientReDetail(applyList);

            return 1;
        }
        public int QueryDiagnosisList(string name, string code, ref ArrayList applyList)
        {
            // SQL语句
            string sql = "";
            //
            // 获取SQL语句
            //
            if (this.Sql.GetSql("Terminal.TerminalConfirm.QueryDiagnosisList", ref sql) == -1)
            {
                this.Err = "获取SQL语句Terminal.TerminalConfirm.QueryDiagnosisList失败";
                return -1;
            }
            try
            {
                if (name != "" && code != "") {
                    ...
                    sql = sql + "where ITEM_NAME= '{0}' and ITEM_CODE= '{1}'";
                }
                else if (name != "" && code == "")
                {
                    sql = sql + "where ITEM_NAME= '{0}'";
                }
                else if (name == "" && code != "")
                {
                    sql = sql + "where ITEM_CODE= '{1}'";
                }
                //sql = string.Format(sql, GetParam(medTechItem));

                this.ExecQuery(sql, name, code);
            }
            catch (Exception ee)
            {
                this.Err = ee.Message;
        ...
        private void FillInpatientConfirmDetail(ArrayList applyList)
        {
            ...
            while (this.Reader.Read()) // 循环读取继承的Reader对象
            {
                ...
                //confirmDetail.CancelInfo.OperTime = Neusoft.FrameWork.Function.NConvert.ToDateTime(this.Reader[14].ToString());
        ...
        /// <param name="applyList"></param>
        /// <returns></returns>
        private void FillInpatientReDetail(ArrayList applyList)
        {
            // 定义承载对象
            Neusoft.HISFC.Models.Terminal.TerminalConfirmDetail confirmDetail;
            ...
            {
                confirmDetail = new TerminalConfirmDetail();
                confirmDetail.Apply.Item.ID = this.Reader[0].ToString();
                confirmDetail.Apply.Item.Name = this.Reader[1].ToString();
                confirmDetail.Apply.Item.ConfirmedQty = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.Reader[2].ToString());
                confirmDetail.Apply.Order.DoseUnit= this.Reader[3].ToString();
                confirmDetail.Apply.Item.FT.TotCost = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.Reader[4].ToString());
                confirmDetail.Apply.Item.RecipeOper.ID = this.Reader[5].ToString();
                confirmDetail.Apply.Item.ExecOper.OperTime = Neusoft.FrameWork.Function.NConvert.ToDateTime(this.Reader[6].ToString());
                confirmDetail.Apply.ID = this.Reader[7].ToString();
                confirmDetail.ExecMoOrder = this.Reader[8].ToString();
                confirmDetail.Apply.Name= this.Reader[9].ToString();
                //confirmDetail.CancelInfo.ID  = this.Reader[6].ToString();
                //confirmDetail.CancelInfo.ID = this.Reader[13].ToString();
                //confirmDetail.CancelInfo.OperTime = Neusoft.FrameWork.Function.NConvert.ToDateTime(this.Reader[14].ToString());
        ...
        /// <param name="MoOrder"></param>
        /// <returns></returns>
        public int QueryConfirmInfoByClinicNoCancel(string clinicNo, string deptID, ref List<Neusoft.HISFC.Models.Terminal.TerminalApply> apply)
        {
            string strSql = "";
            // 获取SQL语句
        ...
        /// <returns></returns>
        public List<Neusoft.HISFC.Models.Terminal.TerminalConfirmDetail> QueryTerminalConfirmDetailByQuitFee(Neusoft.HISFC.Models.Fee.ReturnApply QuitFee)
        {
            string strSql = GetInpatientConfirmDetailSql();
            if (strSql == null)
            {
        ...
        /// <returns></returns>
        public int UpdateTerminalDetailRecipe(Neusoft.HISFC.Models.Fee.Inpatient.FeeItemList feeItemList)
        {
            string strSql = "";
        ...
        private List<Neusoft.HISFC.Models.Terminal.TerminalConfirmDetail> QuertMyTerminalConfirmDetail(string strSql)
        {
            ...
            while (this.Reader.Read())
            {
                ...
                obj.FreeCount = Neusoft.FrameWork.Function.NConvert.ToInt32(this.Reader[17].ToString());
                list.Add(obj);
            }
            return list;
        }
        ...
        /// </summary>
        /// <returns>1：成功/-1：失败</returns>
        public int CancelInpatientConfirmDetail2(Neusoft.HISFC.Models.Terminal.TerminalConfirmDetail detail)
        {
            string strSql = "";
            string status = "";
            if (this.Sql.GetSql("Management.Terminal.TerminalConfirm.CancelInpatientConfirmDetail", ref strSql) == -1)
        ...
        /// </summary>
        /// <returns>1：成功/-1：失败</returns>
        public int CancelInpatientConfirmDetailCancel1(Neusoft.HISFC.Models.Terminal.TerminalConfirmDetail detail)
        {
            string strSql = "";
            string status = "";
        ...
        /// </summary>
        /// <returns>1：成功/-1：失败</returns>
        public int CancelInpatientConfirmDetailCancal(Neusoft.HISFC.Models.Terminal.TerminalConfirmDetail detail)
        {
            string strSql = "";
            string status = "";
        ...
        /// </summary>
        /// <returns>1：成功/-1：失败</returns>
        public int CancelInpatientConfirmMoOrderCancel1(Neusoft.HISFC.Models.Terminal.TerminalConfirmDetail detail)
        {
            string strSql = "";
        ...
        /// </summary>
        /// <returns>1：成功/-1：失败</returns>
        public int CancelInpatientConfirmMoOrderCancel(Neusoft.HISFC.Models.Terminal.TerminalConfirmDetail detail)
        {
            string strSql = "";
        ...
        /// </summary>
        /// <returns>1：成功/-1：失败</returns>
        public int CancelInpatientItemListCancel1(Neusoft.HISFC.Models.Terminal.TerminalConfirmDetail detail)
        {
            string strSql = "";
        ...
        /// </summary>
        /// <returns>1：成功/-1：失败</returns>
        public int CancelInpatientItemListCancel(Neusoft.HISFC.Models.Terminal.TerminalConfirmDetail detail)
        {
            string strSql = "";
        ...
        public decimal GetPackageItemPackQty(string MoOrder, string ExeNO)
        {
            ...
            while (this.Reader.Read())
            {
                packQty = Neusoft.FrameWork.Function.NConvert.ToDecimal(this.Reader[0]);
            }
            return packQty;
        }
