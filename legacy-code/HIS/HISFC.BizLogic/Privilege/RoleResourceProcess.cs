...
namespace Neusoft.HISFC.BizLogic.Privilege
{
    ...
    public class RoleResourceProcess : DataBase
    {
        ...
        public List<String> QueryByResType(string type)
        {
            ...
            try
            {
                sql = string.Format(sql, type,Neusoft.FrameWork.Management.Connection.Hospital.ID);
            }
        ...
        private int Insert(RoleResourceMapping info)
        {
            ...
            info.Icon,
            Neusoft.FrameWork.Management.Connection.Hospital.ID,
            info.EmplSql,
            info.DeptSql
            };
        ...
        public List<RoleResourceMapping> QueryByTypeParentId(String type, String parentId)
        {
            ...
            try
            {
                sql = string.Format(sql, type, parentId,Neusoft.FrameWork.Management.Connection.Hospital.ID);
            }
            catch (Exception ex) { this.Err = ex.Message; return null; }
            return this.QueryList(sql);
        }
        ...
        private List<RoleResourceMapping> QueryByTypeRole(String type, String roleId)
        {
            ...
            try
            {
                sql = string.Format(sql, type, roleId,Neusoft.FrameWork.Management.Connection.Hospital.ID);
            }
            catch (Exception ex) { this.Err = ex.Message; return null; }
            return this.QueryList(sql);
        }
        ...
        private int Delete(RoleResourceMapping info)
        {
            ...
            try
            {
                sql = string.Format(sql, info.Id,Neusoft.FrameWork.Management.Connection.Hospital.ID);
            }
            catch (Exception ex) { this.Err = ex.Message; return -1; }
