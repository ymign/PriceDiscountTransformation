...
namespace Neusoft.HISFC.BizLogic.EPR
{
    ...
    public class DataFileInfo : Neusoft.FrameWork.Management.Database, Neusoft.HISFC.Models.Base.IManagement
    {
        ...
        /// <param name="id">id</param>
        /// <returns></returns>
        public System.Collections.Generic.IList<Neusoft.HISFC.Models.File.DataFileInfo> Get(object id, string dataType)
        {
            // TODO:  添加 DataFileInfo.Get 实现
            string strSql = "";
            ...
            if (this.ExecQuery(strSql) == -1) return null;
            Neusoft.HISFC.Models.File.DataFileInfo DataFileInfo = null;
            System.Collections.Generic.IList<Neusoft.HISFC.Models.File.DataFileInfo> listFileInfo = new System.Collections.Generic.List<Neusoft.HISFC.Models.File.DataFileInfo>();
            while (this.Reader.Read())
            {
                DataFileInfo = new Neusoft.HISFC.Models.File.DataFileInfo();
