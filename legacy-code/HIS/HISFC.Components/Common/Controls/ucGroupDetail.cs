    ...
    public partial class ucGroupDetail : FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private int AddDetailToFP(Neusoft.HISFC.Models.Fee.ComGroupTail detail)
        {
            ...
            if (detail.drugFlag == "1")
            {
                ...
                comboType.Items = (new string[]{(drug as Neusoft.HISFC.Models.Pharmacy.Item).MinUnit,
                                                (drug as Neusoft.HISFC.Models.Pharmacy.Item).PackUnit});
                ...
                if (string.IsNullOrEmpty(detail.unitFlag) || Neusoft.FrameWork.Public.String.IsNumeric(detail.unitFlag) == false)
                {
                    detail.unitFlag = "1";
                }
                ...
                {
                    this.fpSpread1_Sheet1.SetValue(row, (int)Cols.Unit, ((Neusoft.HISFC.Models.Pharmacy.Item)drug).PackUnit, false);
                    drug.PriceUnit = ((Neusoft.HISFC.Models.Pharmacy.Item)drug).PackUnit;
                    price = Neusoft.FrameWork.Public.String.FormatNumber(drug.Price, 4);
                    this.fpSpread1_Sheet1.SetValue(row, (int)Cols.Price, price, false);
                }
                else
                {
                    price = Neusoft.FrameWork.Public.String.FormatNumber(drug.Price / drug.PackQty, 4);
                    this.fpSpread1_Sheet1.SetValue(row, (int)Cols.Price, price, false);
                    this.fpSpread1_Sheet1.SetValue(row, (int)Cols.Unit, ((Neusoft.HISFC.Models.Pharmacy.Item)drug).MinUnit, false);
                    drug.PriceUnit = ((Neusoft.HISFC.Models.Pharmacy.Item)drug).MinUnit;
        ...
        private int AddDetailToFP(Neusoft.HISFC.Models.Base.Item item, int row)
        {
            ...
            if (item.ItemType == EnumItemType.Drug)
            {
                ...
                {
                    this.fpSpread1_Sheet1.SetValue(row, (int)Cols.Unit, ((Neusoft.HISFC.Models.Pharmacy.Item)item).PackUnit, false);
                ...
                else
                {
                    ...
                    this.fpSpread1_Sheet1.SetValue(row, (int)Cols.Price, price, false);
                    this.fpSpread1_Sheet1.SetValue(row, (int)Cols.Unit, ((Neusoft.HISFC.Models.Pharmacy.Item)item).MinUnit, false);
        ...
        protected override bool ProcessCmdKey(ref System.Windows.Forms.Message msg, Keys keyData)
        {
            ...
            if (keyData == Keys.F4)
            {
                Neusoft.FrameWork.WinForms.Controls.NeuTextBox txt = new Neusoft.FrameWork.WinForms.Controls.NeuTextBox();
                txt.Size = new Size(200, 40);
                txt.KeyDown += new KeyEventHandler(txt_KeyDown);
                Neusoft.FrameWork.WinForms.Classes.Function.PopShowControl(txt);
            }
            ...
            if (e.Column == (int)Cols.Unit)
            {
                ...
                if (((FarPoint.Win.FpCombo)e.EditingControl).SelectedIndex == 0)
                {
                    ...
                    decimal price = Neusoft.FrameWork.Public.String.FormatNumber(
                        (item as Neusoft.HISFC.Models.Base.Item).Price /
                        (item as Neusoft.HISFC.Models.Base.Item).PackQty, 4);
                ...
                else if (((FarPoint.Win.FpCombo)e.EditingControl).SelectedIndex == 1)
                {
                    ...
                    decimal price = (item as Neusoft.HISFC.Models.Base.Item).Price;
                    this.fpSpread1_Sheet1.SetValue(e.Row, (int)Cols.Price, price, false);
