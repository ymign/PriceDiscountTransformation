...
namespace Neusoft.HISFC.Components.Common.Controls
{
    ...
    ///  />
    /// </summary>
    public partial class ucInItemList : UserControl, Neusoft.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        ...
        string showSettingXML = Neusoft.FrameWork.WinForms.Classes.Function.CurrentPath + Neusoft.FrameWork.WinForms.Classes.Function.SettingPath + "InpatientChargeFeeItem.xml";

        void fpSpread1_ColumnWidthChanged(object sender, FarPoint.Win.Spread.ColumnWidthChangedEventArgs e)
        {
            Neusoft.FrameWork.WinForms.Classes.CustomerFp.SaveColumnFormatProperty(fpSpread1_Sheet1, showSettingXML);
        }

        public ucInItemList(EnumShowItemType type)
        {
        ...
        /// 登录科室
        /// </summary>
        Neusoft.FrameWork.Models.NeuObject deptLogin = ((Neusoft.HISFC.Models.Base.Employee)Neusoft.FrameWork.Management.Connection.Operator).Dept;
        //dataview中的当前行
        ...
        /// 控制参数
        /// </summary>
        private Neusoft.HISFC.BizProcess.Integrate.Common.ControlParam controlArguments = new Neusoft.HISFC.BizProcess.Integrate.Common.ControlParam();
        ...
        protected virtual  int Init()
        {
            ...
            onlyInpatientItem = controlArguments.GetControlParam<bool>("201026");

            isUseRetailPrice2 = controlArguments.GetControlParam<bool>("HNPHA2");

            if (System.IO.File.Exists(showSettingXML))
            {
                Neusoft.FrameWork.WinForms.Classes.CustomerFp.ReadColumnFormatProperty(fpSpread1_Sheet1, showSettingXML);
            }
            return 1;
        }
        //{4AAE2DA2-80C2-4297-A0F2-7E314F8BBF6D}
        ...
        private int AddItemsToArrayList(string patientDept)
        {
            try
            {
                ...
                else if (_enuShowItemType == EnumShowItemType.Material)
                {
                    Neusoft.HISFC.BizLogic.Fee.Item _items = new Neusoft.HISFC.BizLogic.Fee.Item();
                    ArrayList _al1 = new ArrayList(_items.QueryValidItemsListWithInMaterial().ToArray());
                    _alItems = _al1;
                }
                ...
                else
                {
                    ...
                    Neusoft.HISFC.BizLogic.Fee.Item _items2 = new Neusoft.HISFC.BizLogic.Fee.Item();
                    ArrayList _al2 = new ArrayList(_items2.QueryValidItemsListWithIn().ToArray());
                    _alItems = _al1;
                    _alItems.AddRange(_al2);
                    //物资
