...
{ /// <summary>
    ...
    /// />
    /// </summary>
    public partial class ucDiagNoseInput : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        [Description("整理员类型")]
        public Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes OperType
        {
            set
            {
                this.frmType = value;
        ...
        protected override Neusoft.FrameWork.WinForms.Forms.ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            toolBarService.AddToolButton("刷新", "刷新", Neusoft.FrameWork.WinForms.Classes.EnumImageList.S刷新, true, false, null);
            toolBarService.AddToolButton("删除", "删除", Neusoft.FrameWork.WinForms.Classes.EnumImageList.S删除, true, false, null);
            toolBarService.AddToolButton("打印", "打印", Neusoft.FrameWork.WinForms.Classes.EnumImageList.D打印, true, false, null);
        ...
        public bool ConvertBool(object obj)
        {
            ...
            return Neusoft.FrameWork.Function.NConvert.ToBoolean(obj);
        }
        #endregion
        ...
        public override int Save(object sender, object neuObject)
        {
            ...
            #region 删除
            if (diagNose.DeleteDiagnoseAll(this.inpatientNo, frmType, Neusoft.HISFC.Models.Base.ServiceTypes.I) < 0)
            {
                Neusoft.FrameWork.Management.PublicTrans.RollBack();
        ...
        public int LoadInfo(string InpatientNO) //Neusoft.HISFC.Models.RADT.PatientInfo patientInfo, Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes Type)
        {
            try
            {
                ...
                if (frmType == Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes.DOC) // 医生站录入病历
                {
                    ...
                    {
                        //从医生站录入的信息中查询
                        diagList = diag.QueryCaseDiagnose(patient.ID, "%", Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes.DOC, Neusoft.HISFC.Models.Base.ServiceTypes.I);
                    }
                    else
                    {
                        // 病案已经封存已经不允许医生修改和查阅
                ...
                else if (frmType == Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes.CAS)//病案室录入病历
                {
                    ...
                    else if (patient.CaseState == "3")
                    {
                        ...
                        diagList = diag.QueryCaseDiagnose(patient.ID, "%", Neusoft.HISFC.Models.HealthRecord.EnumServer.frmTypes.CAS, Neusoft.HISFC.Models.Base.ServiceTypes.I);
                    }
        ...
        private void AddInfoToFP(ArrayList alReturn)
        {
            ...
            //循环插入信息
            foreach (Neusoft.HISFC.Models.HealthRecord.Diagnose info in alReturn)
            {
                ...
                this.fpEnter1_Sheet1.Cells[0, (int)Cols.disease].Value = Neusoft.FrameWork.Function.NConvert.ToBoolean(info.Is30Disease);
                this.fpEnter1_Sheet1.Cells[0, (int)Cols.clpa].Value = Neusoft.FrameWork.Function.NConvert.ToBoolean(info.CLPA);
                ...
                this.fpEnter1_Sheet1.Cells[0, (int)Cols.dubdiag].Value = Neusoft.FrameWork.Function.NConvert.ToBoolean(info.DubDiagFlag);
