...
//			propertyGrid1.SelectedObjects = new object[]{patientInfo,Patient.Patient,Patient.PayKind,Patient.PVisit,Patient.SIMainInfo,Patient.Caution,Patient.Diagnoses,Patient.Disease};
	 ...
	 class PatientInfo:IBaseProperty
	{
		...
		[DescriptionAttribute("在院状态。"),showChinese("G.状态"),CategoryAttribute("1.患者基本信息"),ReadOnlyAttribute(false)]
		...
		[DescriptionAttribute("出院日期。"),showChinese("H.出院日期"),CategoryAttribute("1.患者基本信息"),ReadOnlyAttribute(false)]
        ...
        [DescriptionAttribute("责任医师，住院医师。"), showChinese("住院医师:"), CategoryAttribute("2.住院信息"), ReadOnlyAttribute(false)]
