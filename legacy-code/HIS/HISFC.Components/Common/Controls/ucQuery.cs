...
namespace Neusoft.HISFC.Components.Common.Controls
{
    public partial class ucQuery : UserControl
    {
        ...
        protected Neusoft.HISFC.BizLogic.Manager.Constant con = new Neusoft.HISFC.BizLogic.Manager.Constant();
        #endregion
        ...
        protected void insertValueBox(string type, string defaultValue, string originalType)
        {
            ...
            {
                combox = new Neusoft.FrameWork.WinForms.Controls.NeuComboBox();
                ((Neusoft.FrameWork.WinForms.Controls.NeuComboBox)combox).AddItems(con.GetList(originalType));
            }
            else//其它用户定义
            {
                combox = new Neusoft.FrameWork.WinForms.Controls.NeuComboBox();
