...
namespace Neusoft.HISFC.Components.Common.Controls
{
    ...
    /// </summary>
    public partial class ucReportBaseHaveDept : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.FrameWork.WinForms.Forms.IReport
    {
        public ucReportBaseHaveDept()
        {
            InitializeComponent();
        }
