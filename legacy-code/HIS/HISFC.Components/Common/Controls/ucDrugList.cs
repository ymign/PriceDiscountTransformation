...
namespace Neusoft.HISFC.Components.Common.Controls
{
    ...
    public partial class ucDrugList : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        private void SetFormatForStorage(int isShowStorage)
        {
            ...
            this.neuSpread1_Sheet1.Columns.Get(5).Visible = Neusoft.FrameWork.Function.NConvert.ToBoolean(isShowStorage);
        ...
        /// </summary>
        /// <param name="al">al中的实体为Neusoft.HISFC.Object.Pharmacy.Item</param>
