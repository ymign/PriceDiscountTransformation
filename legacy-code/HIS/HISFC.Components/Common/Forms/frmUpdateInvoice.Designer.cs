namespace Neusoft.HISFC.Components.Common.Forms
{
    partial class frmUpdateInvoice
    {
        ...
        {
            this.ucUpdateInvoice = new Neusoft.HISFC.Components.Common.Controls.ucUpdateUsedInvoiceNo();
            this.SuspendLayout();
            // 
            // ucUpdateInvoice
            // 
        ...
        private Neusoft.HISFC.Components.Common.Controls.ucUpdateUsedInvoiceNo ucUpdateInvoice;
    }
}