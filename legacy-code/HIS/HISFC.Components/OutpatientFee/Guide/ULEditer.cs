...
{
    public partial class ULEditer : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
				...
				(new System.Data.DataColumn[] 
					{
						...
						new System.Data.DataColumn("标本代码", Type.GetType("System.String")),    //2
						new System.Data.DataColumn("标本名称", Type.GetType("System.String")), //3
        ...
        private DataRow SetRow(DataRow dr, Neusoft.HISFC.Models.Fee.Outpatient.MZGuideContrast item)
        {
            if (item != null)
            {
                ...
                dr["标本代码"] = item.LabCode;

                dr["标本名称"] = item.LabName;
		...
		{
            ULItemEditer f = new ULItemEditer(null);
        ...
        private void ModifiedInfo()
        {
            ...
            ULItemEditer f = new ULItemEditer(this.GetItemInfo());
            //f.SetBedInfo( this.GetBedInfo());
            f.StartPosition = FormStartPosition.CenterParent;
            if (f.ShowDialog() == DialogResult.OK)
            {
        ...
        void InitData()
        {
            try
            {
                ...
                list = new Neusoft.HISFC.BizLogic.Fee.MZGuide().QueryGuideULContrast();
