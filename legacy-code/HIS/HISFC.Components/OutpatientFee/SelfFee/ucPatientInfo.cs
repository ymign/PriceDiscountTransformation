    ...
    public partial class ucPatientInfo : UserControl, Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientInfomation
    {
        ...
        private void tbCardNO_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                ////        return;
                ////    }
                ////    cardNoAuto = Clinic.Function.Charge.GetControlValue(myCtrl, null, neusoft.Common.Clinic.Class.Const.NO_REG_CARD_RULES, "9") + cardNoAuto;
                ...
                ////    Neusoft.HISFC.Models.RADT.Person p = this.myPerson.GetPersonByID(workNo);
                ...
                ////    string empRegDept = Clinic.Function.Charge.GetControlValue(myCtrl, null, neusoft.Common.Clinic.Class.Const.EMPLOYEE_SEE_DEPT, string.Empty);
