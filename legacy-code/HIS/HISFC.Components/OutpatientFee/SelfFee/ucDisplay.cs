...
namespace Neusoft.HISFC.Components.OutpatientFee.SelfFee
{
    public partial class ucDisplay : UserControl, Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IOutpatientItemInputAndDisplay,Neusoft.FrameWork.WinForms.Forms.IInterfaceContainer
    {
        ...
        /// 院内注射次数控件
        /// </summary>
        private Controls.ucInjec myInjec = new Neusoft.HISFC.Components.OutpatientFee.Controls.ucInjec();
                ...
                if (this.rInfo.Pact.PayKind.ID == "01")//自费
                {
                    ...
                    if (this.isOwnDisplayYB)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                this.fpSpread1_Sheet1.Cells[currRow, (int)Columns.Self].Text = "记账";
                            ...
                            if (pactRate != null)
                            {
                                if (feeTempItem.ItemRateFlag != "3")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        this.fpSpread1_Sheet1.Cells[i, (int)Columns.Self].Text = "记账";
