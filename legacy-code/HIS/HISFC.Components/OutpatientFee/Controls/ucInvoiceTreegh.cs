...
namespace Neusoft.HISFC.Components.OutpatientFee.Controls
{
    ...
    /// 显示发票控件
    /// </summary>
    public partial class ucInvoiceTreegh : UserControl
    {
        #region 成员
        /// <summary>
        /// 默认宽度
        ...
        private void txtCardNO_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            iTemp = outpatientManager.QueryInvoiceInfoByCardNoGH(objCard.Patient.PID.CardNO, dtReg, dtRegEnd, out lstInvoice);
