...
namespace Neusoft.HISFC.Components.OutpatientFee.Controls
{
    ...
    /// 发票重打
    /// </summary>
    public partial class ucRePrintInvoiceforatm : Neusoft.FrameWork.WinForms.Controls.ucBaseControl, Neusoft.FrameWork.WinForms.Forms.IInterfaceContainer, IReprintInvoice
    {
        #region 成员
        /// <summary>
        /// 重打发票是否走号
        ...
        protected void PrintMedicalBanlance()
        {
            ...
            GDSI.ZhuHaiSI.Print.ucMZInpatientBalanceInfo uc = new GDSI.ZhuHaiSI.Print.ucMZInpatientBalanceInfo();
