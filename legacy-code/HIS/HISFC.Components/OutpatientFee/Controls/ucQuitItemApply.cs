                        ...
                        if (this.ckbAllQuit.Checked)
                        {
                            if (!this.isNeedAllQuit || f.Item.SysClass.ID.ToString() != "PCC")
                            {
                                ...
                                if (findRow == -1)
                                {
                                    ...
                                    if (ITruncFee != null)
                                    {
                                        this.fpSpread2_Sheet1.Cells[findRow, (int)DrugListQuit.Cost].Text = Neusoft.FrameWork.Function.NConvert.ToDecimal(ITruncFee.TruncFee(f.ConfirmedQty / f.Item.PackQty * f.Item.Price)).ToString();
                                    }
                                    else
                                    {
                                ...
                                else //找到了累加数量
                                {
                                    ...
                                    if (ITruncFee != null)
                                    {
                                        this.fpSpread2_Sheet1.Cells[findRow, (int)DrugListQuit.Cost].Text = Neusoft.FrameWork.Function.NConvert.ToDecimal(ITruncFee.TruncFee(fFind.Item.Qty / f.Item.PackQty * f.Item.Price)).ToString();
                                    }
                                    else
                                    {
