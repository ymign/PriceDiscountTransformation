...
{
    public partial class ucScanPayCanclFee : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        /// <summary>
        /// 尝试退款计数，超过3弹出按钮提供退款
        /// </summary>
        ...
        private void btnReFund_Click(object sender, EventArgs e)
        {
            ...
            SRFInfo.Payment_At = paymentAt.ToString("yyyy-MM-dd hh:mm:ss");
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (!DateTime.TryParse(dataGridView1.Rows[e.RowIndex].Cells["payment_at"].Value.ToString(), out paymentAt))
            {
