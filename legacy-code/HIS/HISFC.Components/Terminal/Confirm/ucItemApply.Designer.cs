...
namespace Neusoft.HISFC.Components.Terminal.Confirm
{
	partial class ucItemApply
	{
		...
		private void InitializeComponent()
		{
            ...
            this.fpSpread1 = new Neusoft.FrameWork.WinForms.Controls.NeuFpEnter(this.components);
		...
		/// 终端确认项目Panel
		/// </summary>
		private Neusoft.FrameWork.WinForms.Controls.NeuPanel neuPanelTerminalApply;
		/// <summary>
		/// 确认项目的所属发票信息Panel
		/// </summary>
		private Neusoft.FrameWork.WinForms.Controls.NeuPanel neuPanelInvoiceInformation;
		/// <summary>
		/// 分割条
		/// </summary>
		...
		/// 终端确认项目标题Panel
		/// </summary>
		private Neusoft.FrameWork.WinForms.Controls.NeuPanel neuPanelApplyTitle;
		/// <summary>
		/// 终端确认项目标题
		/// </summary>
		private Neusoft.FrameWork.WinForms.Controls.NeuLabel neuLabelApplyTitle;
		/// <summary>
		/// 终端确认项目Panel
		/// </summary>
		private Neusoft.FrameWork.WinForms.Controls.NeuPanel neuPanelApplyGrid;
		/// <summary>
		/// 终端确认项目
		/// </summary>
		public Neusoft.FrameWork.WinForms.Controls.NeuFpEnter fpSpread1;
		/// <summary>
		/// 终端确认项目
		/// </summary>
		...
		/// 发票标题Panel
		/// </summary>
		private Neusoft.FrameWork.WinForms.Controls.NeuPanel neuPanelInvoiceTitle;
		/// <summary>
		/// 发票标题
		/// </summary>
        private Neusoft.FrameWork.WinForms.Controls.NeuLabel neuLabelInvoiceTitle;
		/// <summary>
		/// 发票
		/// </summary>
		private Neusoft.FrameWork.WinForms.Controls.NeuSpread fpSpread2;
		/// <summary>
		/// 发票
		/// </summary>
