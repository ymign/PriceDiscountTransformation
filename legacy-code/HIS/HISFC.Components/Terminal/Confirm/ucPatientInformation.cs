...
namespace Neusoft.HISFC.Components.Terminal.Confirm
{
	...
	public partial class ucPatientInformation : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
	{
        ...
        Neusoft.HISFC.BizProcess.Integrate.Registration.Registration regIntegrate = 
            new Neusoft.HISFC.BizProcess.Integrate.Registration.Registration();
        ...
        public Neusoft.HISFC.Models.Registration.Register Register
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    Neusoft.HISFC.Models.Registration.Register regTemp = new Register();
                    regTemp = regIntegrate.QueryPatient(value.ID)[0] as Neusoft.HISFC.Models.Registration.Register;
                ...
                if (register != null)
                {
                    ...
                    this.lblSeeDate.Text = register.DoctorInfo.Templet.Begin.ToString("yyyy-MM-dd HH:mm") + Neusoft.SOC.HISFC.BizProcess.Cache.Common.GetNoonByTime(register.DoctorInfo.Templet.Begin).Name;
                }
                else
                {
                    this.textBoxAge.Text = "";
