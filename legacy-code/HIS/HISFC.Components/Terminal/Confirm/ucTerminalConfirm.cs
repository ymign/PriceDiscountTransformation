...
namespace Neusoft.HISFC.Components.Terminal.Confirm
{
    ...
    public partial class ucTerminalConfirm : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        //add by allan 增加读取医保卡以及身份证时间
        /// <summary>
        /// 读取身份证
        /// </summary>
        protected event System.EventHandler ReadIdCardEvent;

        /// <summary>
        /// 读取医保卡
        /// </summary>
        protected event System.EventHandler ReadMCardEvent;
        ...
        protected override ToolBarService OnInit(object sender, object neuObject, object param)
        {
            ...
            // add by allan
            this.ReadIdCardEvent += new EventHandler(ucTerminalConfirm_ReadIdCardEvent);
            this.ReadMCardEvent += new EventHandler(ucTerminalConfirm_ReadMCardEvent);
            toolbarService.AddToolButton("身份证", "身份证", (int)Neusoft.FrameWork.WinForms.Classes.EnumImageList.M模版, true, false, ReadIdCardEvent);
            toolbarService.AddToolButton("读卡", "", (int)Neusoft.FrameWork.WinForms.Classes.EnumImageList.S手动录入, true, false, ReadMCardEvent);
            //end add
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void ucTerminalConfirm_ReadMCardEvent(object sender, EventArgs e)
        {
            ...
            Neusoft.HISFC.Models.Registration.Register regObjSub = new Neusoft.HISFC.Models.Registration.Register();
            ...
            returnValue = MedcareInterfaceProxy.GetRegInfoOutpatient(regObjSub);
            if (returnValue != 1)
            {
            ...
            ArrayList alPatient = patientMgr.QueryComPatientInfoListByIDNO(regObjSub.IDCard);
            if (alPatient.Count > 0)
            {
                ...
                ucPatientInformation.textBoxCode.Text = patientinfo.PID.CardNO;
                ucPatientInformation_KeyDownInQureyCode(sender, (KeyEventArgs)e);
            }
            else
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void ucTerminalConfirm_ReadIdCardEvent(object sender, EventArgs e)
        {
        ...
        void ucTerminalConfirm_PatientCaseEvent(object sender, EventArgs e)
        {
            ...
            {
                //{971F13CD-0523-4ea4-A0F5-02DA57698331} modified by shangxw 2009-12-14 当点到的不是患者的时候抛异常
                Neusoft.HISFC.Models.Registration.Register registerInfo =ucPatientInformation.Register;
                if (registerInfo == null || registerInfo.ID=="")
                {
                    MessageBox.Show("请选择患者！", "提示");
                    return;
                }
                string url = "http://172.16.61.119:8085/Default.aspx?hisInpatientID={0}&Out={1}";
                url = string.Format(url, registerInfo.ID, "1");
