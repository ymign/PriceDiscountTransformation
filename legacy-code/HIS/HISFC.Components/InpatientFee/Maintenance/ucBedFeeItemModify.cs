...
namespace Neusoft.HISFC.Components.InpatientFee.Maintenance
{
    ...
    public partial class ucBedFeeItemModify : UserControl
    {
        ...
        protected virtual void Modify()
        {
            ...
            this.ckExtFlag.Checked = Neusoft.FrameWork.Function.NConvert.ToBoolean(this.bedFeeItem.ExtendFlag);
        ...
        protected virtual int Confirm()
        {
            ...
            this.bedFeeItem.ExtendFlag = Neusoft.FrameWork.Function.NConvert.ToInt32(this.ckExtFlag.Checked).ToString();
