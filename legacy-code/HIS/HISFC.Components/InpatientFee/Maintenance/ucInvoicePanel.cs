...
namespace Neusoft.HISFC.Components.InpatientFee.Maintenance
{
    ...
    public partial class ucInvoicePanel : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        ...
        /// 当前登录操作员
        /// </summary>
        private Neusoft.HISFC.Models.Base.Employee curOper;
        ...
        {
            //当前操作员
            this.curOper = (Neusoft.HISFC.Models.Base.Employee)this.invoiceServiceManager.Operator;
        ...
        private Neusoft.HISFC.Models.Fee.Invoice CreateInvoiceItem(string personID, string personName)
        {
            ...
            invoice.EndNO = Neusoft.FrameWork.Public.String.AddNumber(currentStartCode, currentCodeNums - 1);
            invoice.UsedNO = Neusoft.FrameWork.Public.String.AddNumber(currentStartCode, -1);
            ...
            currentStartCode = Neusoft.FrameWork.Public.String.AddNumber(currentStartCode, currentCodeNums);
            return invoice;
        }
        ...
        protected virtual bool ValidateNumValid()
        {
            ...
            if (this.ckbStartNO.Checked)
            {
                ...
                try
                {
                    startcode = Neusoft.FrameWork.Public.String.GetNumber(this.txtStart.Text.Trim());// Convert.ToInt64(this.txtStart.Text.Trim());
                }
                ...
                try
                {
                    endcode = Neusoft.FrameWork.Public.String.GetNumber(this.txtEndNO.Text.Trim());//  Convert.ToInt64(this.txtEndNO.Text.Trim());
                }
                catch (FormatException formatException)
                {
        ...
        protected virtual void GenerateInvoices()
        {
            ...
            foreach (Neusoft.HISFC.Models.Fee.Invoice info in invoices)
            {
                ...
                if (this.invoiceServiceManager.InsertInvoiceWithHosCode(info) == -1)
                {
                    result = -1;
                    break;
                }
        ...
        protected virtual void SearchInvoiceBy()
        {
            try
            {
                ...
                if (this.txtpersonCode.Text != "")
                {
                    ...
                    ArrayList List = invoiceServiceManager.QueryInvoicesWithHosCode(this.txtpersonCode.Text.Trim(), type, isGroup, Neusoft.FrameWork.Management.Connection.Hospital.ID);
                    SetDataToGrid(List);
                ...
                else if(this.isShowAll || this.curOper.IsManager)
                {
                    ...
                    ArrayList allList = invoiceServiceManager.QueryInvoicesWithHosCode(type, isGroup, Neusoft.FrameWork.Management.Connection.Hospital.ID);
        ...
        public void ReturnBack()
        {
            ...
            clone.HosCode = Neusoft.FrameWork.Management.Connection.Hospital.ID;
            invoiceReturn.HosCode = Neusoft.FrameWork.Management.Connection.Hospital.ID;
            if (result == DialogResult.OK)
            {
                ...
                if (start == invoiceStart)
                {
                    ...
                    if (invoiceServiceManager.DeleteWithHosCode(clone) == -1)
                        saved = false; ;
                }
                else
                {
                    invoiceReturn.EndNO = Neusoft.FrameWork.Public.String.AddNumber(start, -1);
                    ...
                    if (invoiceServiceManager.UpdateInvoiceWithHosCode(invoiceReturn) == -1)
        ...
        private void txtQty_Enter(object sender, EventArgs e)
        {
            try
            {
                if (this.txtStart.Text.Trim() != "" && this.txtQty.Text.Trim() != "")
                {
                    ...
                    this.txtEndNO.Text = Neusoft.FrameWork.Public.String.AddNumber(this.txtStart.Text.Trim(), Convert.ToInt64(this.txtQty.Text.Trim()) - 1);
                }
            }
            catch (Exception ee)
            {
        ...
        private void txtQty_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (this.txtStart.Text.Trim() != "" && this.txtQty.Text.Trim() != "")
                {
                    ...
                    this.txtEndNO.Text = strStr + Neusoft.FrameWork.Public.String.AddNumber(this.txtStart.Text.Trim().Substring(strStart.Length - 1 - index), Convert.ToInt64(this.txtQty.Text.Trim()) - 1);
                }
            }
            catch (Exception ee)
            {
