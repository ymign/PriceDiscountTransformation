...
{
    public partial class ucPatientFeeQueryNewForm : Neusoft.FrameWork.WinForms.Controls.ucBaseControl
    {
        public ucPatientFeeQueryNewForm()
        {
            InitializeComponent();
