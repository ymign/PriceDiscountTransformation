...
{
    public partial class ucMZGuidePrint : UserControl, Neusoft.HISFC.BizProcess.Interface.Fee.IOutpatientGuideNew
    {

        public ucMZGuidePrint()
        {
            InitializeComponent();
        }
        ...
        private void AddHead()
        {
            this.neuSpread1_Sheet1.RowCount++;
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 0, 1, 6);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Font = new Font("宋体", 9f, FontStyle.Bold);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = this.constManager.GetHospitalName() + "门诊指引单";
        ...
        private void AddPatientInfo()
        {
            ...
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Font = new Font("宋体", 7.5f);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = "发票号:" + this.InvoiceNo;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].HorizontalAlignment = CellHorizontalAlignment.Left;
            if (this.isRePrint)
            {
                this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 3].Font = new Font("宋体", 8.5f, FontStyle.Bold);
                this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 3].Text = "（补打）";
                this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 3].HorizontalAlignment = CellHorizontalAlignment.Center;
            }
            this.neuSpread1_Sheet1.RowCount++;
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 0, 1, 3);
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 3, 1, 3);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Font = new Font("宋体", 7.5f);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = "姓名:" + this.Register.Name;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].HorizontalAlignment = CellHorizontalAlignment.Left;
            this.neuSpread1_Sheet1.RowCount++;
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 0, 1, 3);
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 3, 1, 3);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Font = new Font("宋体", 7.5f);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = "性别:" + (this.Register.Sex == null ? "未填" : this.Register.Sex.ToString());
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].HorizontalAlignment = CellHorizontalAlignment.Left;
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 2, 3, 2, 3);
            ImageCellType cellType = new ImageCellType();
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 2, 3].CellType = cellType;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 2, 3].Value = this.CreateBarCode(this.Register.Card.ID);
            this.neuSpread1_Sheet1.RowCount++;
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 0, 1, 3);
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 3, 1, 3);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Font = new Font("宋体", 7.5f);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = "卡号:" + this.Register.Card.ID;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].HorizontalAlignment = CellHorizontalAlignment.Left;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 3].Font = new Font("宋体", 7.5f);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 3].Text = "挂号日期：" + this.Register.DoctorInfo.SeeDate.ToString("yyyy-MM-dd");
        ...
        private void ULAddLine()
        {
            ...
            //this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = "注：请从开单日期起30天内完成缴费及采血，谢谢配合。";
            // {4DCD64A4-B2D1-4e51-ADB0-55F1E72F8B9B}
        ...
        public void SetValue(Register register, ArrayList balanceList, List<MZGuide> itemList)
        {
            if (itemList != null && itemList.Count != 0)
            {
        ...
        private void PrintOnePage()
        {
            ...
            print.ControlBorder = 0;
            print.PrintPage(pageSize.Left, 0, this);
        ...
        public PageSize GetPageSize()
        {
            ...
            if (pageSize == null)
            {
                pageSize = new PageSize("MZGuide", 260, 260);
            }
        ...
        private void SetNumberText()
        {
            ...
            //this.NumberText.Add(new KeyValuePair<string, string>("1", "①"));
            //this.NumberText.Add(new KeyValuePair<string, string>("2", "②"));
            //this.NumberText.Add(new KeyValuePair<string, string>("3", "③"));
            //this.NumberText.Add(new KeyValuePair<string, string>("4", "④"));
            //this.NumberText.Add(new KeyValuePair<string, string>("5", "⑤"));
            //this.NumberText.Add(new KeyValuePair<string, string>("6", "⑥"));
            //this.NumberText.Add(new KeyValuePair<string, string>("7", "⑦"));
            //this.NumberText.Add(new KeyValuePair<string, string>("8", "⑧"));
            //this.NumberText.Add(new KeyValuePair<string, string>("9", "⑨"));
            //this.NumberText.Add(new KeyValuePair<string, string>("10", "⑩"));
            //this.NumberText.Add(new KeyValuePair<string, string>("11", "⑪"));
            //this.NumberText.Add(new KeyValuePair<string, string>("12", "⑫"));
            //this.NumberText.Add(new KeyValuePair<string, string>("13", "⑬"));
            //this.NumberText.Add(new KeyValuePair<string, string>("14", "⑭"));
            //this.NumberText.Add(new KeyValuePair<string, string>("15", "⑮"));
        ...
        private void SetData(List<MZGuide> ItemList)
        {
            ...
            {
                if (!list.Contains(current.Recipe_NO))
                {
                    list.Add(current.Recipe_NO);
                }
            }
        ...
        private void AddCureHeader()
        {
            ...
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = "检查/治疗/手术/化验项目";
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].VerticalAlignment = CellVerticalAlignment.Center;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].Text = "数量/单位";
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].HorizontalAlignment = CellHorizontalAlignment.Right;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].VerticalAlignment = CellVerticalAlignment.Center;
            this.neuSpread1_Sheet1.Rows[this.neuSpread1_Sheet1.RowCount - 1].Font = new Font("宋体", 7.5f, FontStyle.Bold);
        }
        ...
        private void AddUnDrugHeader(MZGuide obj)
        {
            ...
            {
                this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].Text = "数量/部位";
            }
            else
            {
                this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].Text = "数量";
            }
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].HorizontalAlignment = CellHorizontalAlignment.Right;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].VerticalAlignment = CellVerticalAlignment.Center;
            this.neuSpread1_Sheet1.Rows[this.neuSpread1_Sheet1.RowCount - 1].Font = new Font("宋体", 7.5f, FontStyle.Bold);
        ...
        private void AddGuideTips(MZGuide obj)
        {
            ...
            {
                this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = "请" + text2 + "到" + obj.Exec_Dpnm;
            }
            else
            {
                if (obj.Class_Code == "UL" || obj.Drug_Flag == "1")
                {
                    if (obj.Drug_Flag == "1")
                    {
                        ...
                        {
                            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Font=new Font("宋体", 7.5f, FontStyle.Bold);//10f 
                            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = string.Concat(new string[]
					{
						textTemp
					});
            ...
            if (this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text.Length > 18)
                this.neuSpread1_Sheet1.Rows[this.neuSpread1_Sheet1.RowCount - 1].Height = 30;
        ...
        private void AddUnDrugNote(string Note)
        {
            this.neuSpread1_Sheet1.RowCount++;
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 0, 1, 6);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = "注意事项：" + Note;
            this.neuSpread1_Sheet1.Rows[this.neuSpread1_Sheet1.RowCount - 1].Font = new Font("宋体", 7.5f, FontStyle.Bold);
        }
        private void AddDrugItem(MZGuide obj)
        {
            ...
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Text = name1;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].Text = obj.Qty + "/" + obj.Unit;
            this.neuSpread1_Sheet1.Rows[this.neuSpread1_Sheet1.RowCount - 1].Font = new Font("宋体", 7.5f, FontStyle.Bold);
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].HorizontalAlignment = CellHorizontalAlignment.Right;
            ...
            float len = this.neuSpread1_Sheet1.Columns[0].Width;
            //换行
            float xlength = System.Text.Encoding.GetEncoding("gb2312").GetBytes(obj.Item_Name).Length / len;
        ...
        private void AddUnDrugItem(MZGuide obj)
        {
            ...
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 4, 1, 2);
            string name1 = string.Empty, name2 = string.Empty;
            if (!string.IsNullOrEmpty(obj.Item_Name) && obj.Item_Name.Length > 14)
            {
                name1 = obj.Item_Name.Substring(0, 14);
                name2 = obj.Item_Name.Substring(14);
            }
            if (string.IsNullOrEmpty(name1))
            {
                name1 = obj.Item_Name;
            ...
            else
            {
                if (obj.Class_Code == "UC")
                {
                    ...
                    {
                        this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].Text = obj.Qty + "/" + obj.Check_Body;
                    }
                    else
                    {
                        this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 4].Text = obj.Qty;
                    }
                }
                else
                {
        ...
        private void AddBarCode(string code)
        {
            ...
            this.neuSpread1_Sheet1.Models.Span.Add(this.neuSpread1_Sheet1.RowCount - 1, 0, 1, 6);
            ImageCellType cellType = new ImageCellType();
            this.neuSpread1_Sheet1.Rows[this.neuSpread1_Sheet1.RowCount - 1].Height = 40f;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].CellType = cellType;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].HorizontalAlignment = CellHorizontalAlignment.Left;
            this.neuSpread1_Sheet1.Cells[this.neuSpread1_Sheet1.RowCount - 1, 0].Value = this.CreateBarCode(code);
        }
