    ...
    public partial class ucChooseItemForOutPatient : UserControl, Neusoft.HISFC.BizProcess.Integrate.FeeInterface.IChooseItemForOutpatient
    {
        ...
        private void InitDataTable()
        {
            ...
            if (System.IO.File.Exists(filePath))
            {
                ...
                Neusoft.FrameWork.WinForms.Classes.CustomerFp.CreatColumnByXML(this.filePath, dtItem, ref dvItem, this.fpSpread1_Sheet1);
        ...
        private string QuerySortString()
        {
            ...
            try
            {
                ...
                {
                    Neusoft.HISFC.Components.Common.Classes.Function.CreateFeeSettingOutpatient();
                }
                _doc.Load(Neusoft.FrameWork.WinForms.Classes.Function.SettingPath + "/feeSettingOutpatientFee.xml");
                ...
                _doc.Save(Neusoft.FrameWork.WinForms.Classes.Function.SettingPath + "/feeSettingOutpatientFee.xml");
            }
