...
namespace FS.ZDWY.Internet.UI
{
    public partial class QuitFee : Form
    {
        ...
        private void Test()
        {
            try
            {
                BP.OutPatient.RegisterInfoManager mgr = new BP.OutPatient.RegisterInfoManager();
                string url = "";
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                string regurl = "";
                regurl = this.textregurl.Text;
                mgr.QuitRegFee(regurl);
