...
/// <summary>
/// 规则发布流水实体，记录规则发布、停用和回滚事件。
/// </summary>
/// <remarks>
/// <para>
/// 【对应 Oracle 表】
/// PR_RULE_PUBLISH。主键 PUBLISH_ID 由 SEQUENCE 生成。
/// </para>
/// <para>
/// 【在规则生命周期中的角色】
/// 发布流水用于审计和页面展示，不直接作为计价匹配依据。
...
/// <para>
/// 【缓存失效】
/// 规则发布/停用/回滚时必须立即失效计价引擎的规则缓存。
/// </para>
/// </remarks>
public sealed class RulePublish
{
    /// <summary>
    /// 发布流水主键，对应 Oracle 列 PUBLISH_ID，NUMBER 类型，由 SEQUENCE 生成。
    /// </summary>
    /// <remarks>
    /// 全局唯一标识一条发布流水记录。
    /// </remarks>
