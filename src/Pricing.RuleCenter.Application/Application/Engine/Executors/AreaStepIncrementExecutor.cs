...
/// </para>
/// </remarks>
public sealed class AreaStepIncrementExecutor : IRuleActionExecutor, IFormulaExecutorCapabilityMetadata
{
    /// <inheritdoc />
    public IReadOnlyCollection<string> SupportedExecutorCodes { get; } = new[]
    {
        FormulaExecutorCodes.AreaStepIncrement,
        FormulaExecutorCodes.AreaStepIncrementExecutor
    };
