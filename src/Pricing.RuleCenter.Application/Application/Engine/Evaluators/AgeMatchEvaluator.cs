...
/// <list type="bullet">
///   <item><description>儿童加收规则：年龄 <c>&gt;= 0</c> 且 <c>&lt; 14</c> 岁的患者适用。</description></item>
///   <item><description>老年优惠规则：年龄 <c>&gt;= 60</c> 岁的患者适用。</description></item>
///   <item><description>新生儿特殊计价：年龄 <c>&lt; 28</c> 天的患者适用（需渠道以小数形式传入）。</description></item>
/// </list>
/// </para>
/// <para>
/// 【范围格式】condition.RightValue 使用半开区间表示法，支持以下格式：
/// <list type="bullet">
///   <item><description><c>&gt;=0,&lt;14</c> — 年龄 <c>&gt;= 0</c> 且 <c>&lt; 14</c>（左闭右开）。</description></item>
///   <item><description><c>&gt;=14</c> — 年龄 <c>&gt;= 14</c>（无上界）。</description></item>
///   <item><description><c>&lt;6</c> — 年龄 <c>&lt; 6</c>（无下界）。</description></item>
///   <item><description><c>&gt;=0,&lt;=14</c> — 年龄 <c>&gt;= 0</c> 且 <c>&lt;= 14</c>（左闭右闭）。</description></item>
/// </list>
