...
public sealed class PricingAppService
{
    ...
    /// </summary>
    private readonly ILogger<PricingAppService> _logger;
    ...
    private async Task<long> SaveReverseRequestLogAsync(ReverseRequestLogSaveInput input)
    {
        ...
        var reverseRequestLog = new ChargeRequest
        {
            ...
            RequestFingerprint = PricingRequestFingerprintBuilder.BuildReverseFingerprint(request, originalLog, reverseTime),
    ...
    private async Task<ChargeRequest> SaveRequestLog(RequestLogSaveInput input)
    {
        var request = input.Request;
    ...
    private async Task SaveResponseJson(ChargeRequest log, PricingCalculateResponse response)
    {
    ...
    {
        return PricingLockKeyBuilder.BuildReverseRequestNo(originalRequestId, reverseNo);
    }
