...
builder.Services.AddScoped<PricingTransactionExecutor>();
builder.Services.AddScoped<PricingIdempotentResponseReader>();
builder.Services.AddScoped<PricingReverseHistoryReader>();
builder.Services.AddScoped<PricingSpecialFlagResolver>();
builder.Services.AddScoped<PricingSimulateWorkflow>();
builder.Services.AddScoped<PricingConfirmWorkflow>();
builder.Services.AddScoped<PricingCommitWorkflow>();
builder.Services.AddScoped<PricingCancelWorkflow>();
builder.Services.AddScoped<PricingReverseWorkflow>();
