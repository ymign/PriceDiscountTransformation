...
/// <see cref="PricingApiService"/> 构造函数参数数量，又不会把所有依赖混成一个不透明对象。
/// </remarks>
public sealed class PricingApiCalculationDependencies
{
    /// <summary>
    /// 初始化计价计算侧依赖。
    /// </summary>
    ...
    public PricingApiCalculationDependencies(
...
/// </remarks>
public sealed class PricingApiPersistenceRepositories
{
    /// <summary>
    /// 初始化计价持久化侧仓储集合。
    /// </summary>
    ...
    public PricingApiPersistenceRepositories(
